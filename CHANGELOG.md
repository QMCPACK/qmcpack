...
* GCC 15 workaround prevents incorrect results in complex builds. [#6139](https://github.com/QMCPACK/qmcpack/pull/6139)
...
* `nrule` support for QMC runs. [#6059](https://github.com/QMCPACK/qmcpack/pull/6059)
