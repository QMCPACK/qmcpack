...
* Shared_ranks supported in GPU runs, reducing host-side memory pressure from the large footprint of spline coefficients. [#6173](https://github.com/QMCPACK/qmcpack/pull/6173)
...
* Improved PySCF CASSCF wavefunction conversion. [#6167](https://github.com/QMCPACK/qmcpack/pull/6167)
...
* New generic workstation machine setting "ws" that automatically determines core counts. [#6003](https://github.com/QMCPACK/qmcpack/pull/6003)
* Clearer Nexus status printouts. [#6106](https://github.com/QMCPACK/qmcpack/pull/6106)
* Nexus handles interrupted workstation jobs. [#6105](https://github.com/QMCPACK/qmcpack/pull/6105)
* VASP input and output updated. [#6108](https://github.com/QMCPACK/qmcpack/pull/6108)
* Quantum ESPRESSO input parameters are updated and autogenerated. e.g.  [#6049](https://github.com/QMCPACK/qmcpack/pull/6049), [#6093](https://github.com/QMCPACK/qmcpack/pull/6093)
* RMG input parameters updated. [#6159](https://github.com/QMCPACK/qmcpack/pull/6159)
...
* Significant update of Nexus pseudopotential handling, including to user-facing `PseudoSet` API. e.g.
  [#6043](https://github.com/QMCPACK/qmcpack/pull/6043), [#6132](https://github.com/QMCPACK/qmcpack/pull/6132),
  [#6134](https://github.com/QMCPACK/qmcpack/pull/6134)
* Z-valence parsing is available for UPF, QMCPACK XML, and POTCAR pseudopotentials.
  [#6035](https://github.com/QMCPACK/qmcpack/pull/6035)
