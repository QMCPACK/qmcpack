...
set(CMAKE_FIND_ROOT_PATH
    /opt/freeware
    /u/home/ac/jnkim/src/boost/src
    /u/home/ac/jnkim/build/32
    /u/home/ac/jnkim/apps/32/einspline_r
     )

SET(AIX_BIT_FLAGS "")
SET(AIX_CXX_COMMON_FLAGS "-qrtti=dyna -qnoeh -qsuppress=1540-1090 -qsmp=omp")
#SET(AIX_OPT_FLAGS "-g -O3 -Q -qmaxmem=-1 -qinline -qlargepage -qprefetch -qstrict -qhot -qkeyword=restrict")
...
######################################################################
SET(CMAKE_CXX_FLAGS 
"${CMAKE_CXX_FLAGS} ${AIX_ARCH_FLAGS} ${AIX_CXX_COMMON_FLAGS} ${AIX_OPT_FLAGS}")
SET(CMAKE_C_FLAGS 
"${CMAKE_C_FLAGS} ${AIX_ARCH_FLAGS} ${AIX_OPT_FLAGS} ${AIX_C_FLAGS}")
