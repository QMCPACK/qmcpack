...
// 	BOOST_MULTI_HD constexpr extents_t(multi::size_t size)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) : allow terse syntax
// 	: extents_t{index_extension{size}} {}

// 	template<class T = void, std::enable_if_t<sizeof(T*) && D == 1, int> = 0>  // NOLINT(modernize-use-constraints) TODO(correaa)
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(index_extension ext1)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{ext1} {}
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(detail::tuple<T1> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions)
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(::std::tuple<T1> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{std::move(extensions)} {}
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(detail::tuple<T1, T2> const& extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{extensions} {}
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(::std::tuple<T1, T2> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{std::move(extensions)} {}
...
// 	BOOST_MULTI_HD constexpr extents_t(tuple<T1, T2, T3> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{std::move(extensions)} {}
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(::std::tuple<T1, T2, T3> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{std::move(extensions)} {}
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(tuple<T1, T2, T3, T4> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{std::move(extensions)} {}
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(::std::tuple<T1, T2, T3, T4> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{std::move(extensions)} {}
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(tuple<T1, T2, T3, T4, T5> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions) allow terse syntax
// 	: base_{std::move(extensions)} {}
...
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(::std::tuple<T1, T2, T3, T4, T5> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions)
// 	: base_{std::move(extensions)} {}
...
// 	BOOST_MULTI_HD constexpr extents_t(OtherExtensions const& other)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions)
...
// 	friend constexpr auto operator*(index_extension const& extension, extents_t const& self) -> extents_t<D + 1> {
// 		// return extents_t<D + 1>(tuple(extension, self.base()));
// 		return extents_t<D + 1>(extension, self);
// 	}
...
// 	friend constexpr auto operator%(nelems_type idx, extents_t const& extensions) { return extensions.from_linear(idx); }
...
// 	class elements_t {
// 		extents_t xs_;
// 		explicit constexpr elements_t(extents_t const& xs) : xs_{xs} {}
...
// 	using sizes_type = boost::multi::detail::tuple_prepend_t<size_type, typename extents_t<D - 1>::sizes_type>;
...
// 				intersection(extents_t<D - 1>{self.base().tail()}, extents_t<D - 1>{other.base().tail()}).base()
// 			)
// 		};
// 	}
...
// 	BOOST_MULTI_HD constexpr extents_t(multi::size_t size)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions)
// 	: base_(multi::index_extension{0, size}) {}

// 	template<class T1>
// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int>  // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(tuple<T1> extensions)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions)
// 	: base_{static_cast<multi::index_extension>(extensions.head())} {}

// 	// cppcheck-suppress noExplicitConstructor ; to allow passing tuple<int, int> // NOLINTNEXTLINE(runtime/explicit)
// 	BOOST_MULTI_HD constexpr extents_t(multi::index_extension const& other)  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions)
// 	: base_{other} {}
...
// 	template<std::size_t Index, std::enable_if_t<(Index < 1), int> = 0>      // NOLINT(modernize-use-constraints) TODO(correaa)
// 	friend constexpr auto get(extents_t const& self) -> decltype(auto) {  // -> typename std::tuple_element<Index, base_>::type {
// 		using boost::multi::detail::get;
// 		return get<Index>(self.base());
// 	}
// };
...
// extents_t(multi::size_t) -> extents_t<1>;
// extents_t(multi::size_t, multi::size_t) -> extents_t<2>;
// extents_t(multi::size_t, multi::size_t, multi::size_t) -> extents_t<3>;
// extents_t(multi::size_t, multi::size_t, multi::size_t, multi::size_t) -> extents_t<4>;
// extents_t(multi::size_t, multi::size_t, multi::size_t, multi::size_t, multi::size_t) -> extents_t<5>;
// extents_t(multi::size_t, multi::size_t, multi::size_t, multi::size_t, multi::size_t, multi::size_t) -> extents_t<6>;
// extents_t(multi::size_t, multi::size_t, multi::size_t, multi::size_t, multi::size_t, multi::size_t, multi::size_t) -> extents_t<7>;
...
// constexpr auto
// apply(Fn&& fn, boost::multi::extents_t<D> const& xs) noexcept -> decltype(auto) {  // NOLINT(cert-dcl58-cpp,bugprone-std-namespace-modification) workaround
...
//  public:
// 	constexpr explicit contiguous_layout(multi::extents_t<1> xs)
...
// 	BOOST_MULTI_HD constexpr auto extensions() const { return multi::extents_t<1>{extension()}; }
...
// 	: sub_{apply_        ([](auto const&... subexts) { return multi::extents_t<D - 1>{subexts...}; }, detail::tail(extensions.base()))}
...
// 	: sub_{std::apply([](auto const&... subexts) { return multi::extents_t<D - 1>{subexts...}; }, detail::tail(extensions.base())), detail::tail(strides)}, stride_{boost::multi::detail::get<0>(strides)}, offset_{boost::multi::detail::get<0>(extensions.base()).first() * stride_}, nelems_{boost::multi::detail::get<0>(extensions.base()).size() * sub().num_elements()} {}
// 	#ifdef __NVCC__
...
// template<>
// [[maybe_unused]] constexpr bool enable_borrowed_range<::boost::multi::extents_t<1>::elements_t> = true;  // NOLINT(misc-definitions-in-headers)
