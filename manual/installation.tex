...
cd build_summitdev
cmake -DCMAKE_C_COMPILER="mpicc" -DCMAKE_C_FLAGS="-std=gnu11 -qsmp -O3" -DCMAKE_CXX_COMPILER="mpicxx" -DCMAKE_CXX_FLAGS="-std=gnu++11 -qnoxlcompatmacros -qsmp -O3 "  -DQMC_CUDA=1 ..
make -j 8
ls -l bin/qmcpack 
\end{verbatim}
