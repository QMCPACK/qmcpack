...
In addition, adding a very useful cmake option -DCMAKE\_VERBOSE\_MAKEFILE=TRUE allows printing all the build commands during the make step.
...
tests. They require several hours each to run yielding much more
...
different computer systems and on a continuous basis. We currently test
