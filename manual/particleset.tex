...
\begin{lstlisting}[style=XML,caption=particleset elements for ions and electrons randomizing electron start positions.]
...
\begin{minipage}{\linewidth}
\begin{lstlisting}[style=XML,caption=particleset elements for ions and electrons specifying electron start positions]
  <particleset name="e">
    <group name="u" size="4">
      <parameter name="charge">-1</parameter>
...
\begin{minipage}{\linewidth}
\begin{lstlisting}[style=XML,caption=particleset elements for ions specifying positions by ion type]
