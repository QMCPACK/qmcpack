...
\begin{lstlisting}[style=XML,caption=All electron Hamiltonian XML element.]
...
\begin{lstlisting}[style=XML,caption=Pseudopotential Hamiltonian XML element.]
<hamiltonian target="e">
  <pairpot name="ElecElec"  type="coulomb" source="e" target="e"/>
...
\begin{lstlisting}[style=XML,caption=XML element for Coulomb interaction between electrons.]
  <pairpot name="ElecElec" type="coulomb" source="e" target="e"/>
\end{lstlisting}

\begin{lstlisting}[style=XML,caption=XML element for Coulomb interaction between electrons and ions (all-electron only).]
  <pairpot name="ElecIon"  type="coulomb" source="i" target="e"/>
\end{lstlisting}

\begin{lstlisting}[style=XML,caption=XML element for Coulomb interaction between ions.]
  <pairpot name="IonIon"   type="coulomb" source="i" target="i"/>
\end{lstlisting}
...
\begin{lstlisting}[style=XML,caption=XML element for pseudopotential electron-ion interaction (psf files).]
  <pairpot name="PseudoPot" type="pseudo"  source="i" wavefunction="psi0" format="psf"/>
\end{lstlisting}

\begin{lstlisting}[style=XML,caption=XML element for pseudopotential electron-ion interaction (xml files).]
  <pairpot name="PseudoPot" type="pseudo"  source="i" wavefunction="psi0" format="xml">
    <pseudo elementType="Li" href="Li.xml"/>
    <pseudo elementType="H" href="H.xml"/>
  </pairpot>
...
\begin{lstlisting}[style=XML,caption=XML element for pseudopotential of single ionic species.]
  <pseudo elementType="Li" href="Li.xml"/>
\end{lstlisting}
...
% MPC correction
\begin{lstlisting}[style=XML,caption=Modified periodic coulomb for finite size post-correction.]
...
\begin{lstlisting}[style=XML,caption=``Chiesa'' kinetic energy finite size post-correction.]
...
% density estimator
\begin{lstlisting}[style=XML,caption=Density estimator (uniform grid).]
...
\begin{lstlisting}[style=XML,caption=Spin density estimator (uniform grid).]
  <estimator type="spindensity" name="SpinDensity" report="yes">
    <parameter name="grid"> 40 40 40 </parameter>
  </estimator>
\end{lstlisting}

\begin{lstlisting}[style=XML,caption=Spin density estimator (uniform grid centered about origin).]
  <estimator type="spindensity" name="SpinDensity" report="yes">
    <parameter name="grid">
      20 20 20
    </parameter>
...
\begin{lstlisting}[style=XML,caption=Pair correlation function estimator element.]
  <estimator type="gofr" name="gofr" num_bin="200" rmax="3.0" />
\end{lstlisting}
\begin{lstlisting}[style=XML,caption=Pair correlation function estimator element with additional electron-ion correlations.]
...
\begin{lstlisting}[style=XML,caption=Static structure factor estimator element.]
...
\begin{lstlisting}[style=XML,caption=Species kinetic energy estimator element.]
...
\begin{lstlisting}[style=XML,caption={Lattice deviation estimator element.},label={lst:latdev}]
...
\begin{lstlisting}[style=XML,caption=Energy density estimator accumulated on a 20x10x10 grid over the simulation cell.]
...
\begin{lstlisting}[style=XML,caption=Energy density estimator accumulated within spheres of radius 6.9 Bohr centered on the first and second atoms in the ion0 particleset.]
...
\begin{lstlisting}[style=XML,caption=Energy density estimator accumulated within Voronoi polyhedra centered on the ions.]
...
\begin{lstlisting}[style=XML,caption=One body density matrix with uniform grid integration.]
...
\begin{lstlisting}[style=XML,caption=One body density matrix with uniform sampling.]
  <estimator type="dm1b" name="DensityMatrices">
    <parameter name="basis"        >  spo_u spo_uv  </parameter>
    <parameter name="evaluator"    >  matrix        </parameter>
...
\begin{lstlisting}[style=XML,caption=One body density matrix with density sampling.]
  <estimator type="dm1b" name="DensityMatrices">
    <parameter name="basis"        >  spo_u spo_uv  </parameter>
    <parameter name="evaluator"    >  matrix        </parameter>
...
\begin{lstlisting}[style=XML,caption={Example sposet initialization for density matrix use.  Occupied and virtual orbital sets are created separately, then joined (\texttt{basis="spo\_u spo\_uv"}).}]
...
\begin{lstlisting}[style=XML,caption={Example sposet initialization for density matrix use.  Density matrix orbital basis created separately (\texttt{basis="dm\_basis"}).}]
  <sposet_builder type="bspline" href="../dft/pwscf_output/pwscf.pwscf.h5" tilematrix="1 0 0 0 1 0 0 0 1" twistnum="0" meshfactor="1.0" gpu="no" precision="single">
    <sposet type="bspline" name="spo_u"  group="0" size="4"/>
    <sposet type="bspline" name="spo_d"  group="0" size="2"/>
...
\begin{lstlisting}[style=XML,caption=Forward walking estimator element.]
