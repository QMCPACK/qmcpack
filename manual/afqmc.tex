...
\begin{lstlisting}[style=XML,caption=Sample input file for AFQMC.]
<?xml version="1.0"?>
...
\begin{lstlisting}[style=XML,caption=Example of sections of an AFQMC input file for a large calculation.]
...
