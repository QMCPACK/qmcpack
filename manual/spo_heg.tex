...
\begin{lstlisting}[style=XML,caption=2D Fermi Liquid example: particle specification ]
<qmcsystem>
...
\begin{lstlisting}[style=XML,caption=2D Fermi Liquid example (Slater Jastrow wave function) ]
<qmcsystem>
