...
\begin{lstlisting}[style=XML,caption="Sample XML optimization block.",label=lst:lam_xml_opt]
  <loop max="10">
...
\begin{lstlisting}[style=XML,caption="Sample XML blocks for VMC and DMC calculations.",
label=lst:lam_xml_vmc_dmc]
