...
as ``stabilizers''. The generalized eigenvalue problem is solved for each shifted Hamiltonian and updates to wave function parameters are obtained. Then a correlated sampling 
