...
Additional information:
\begin{itemize}
  \item \ixml{shift\_i}.  This is the initial coefficient used to scale the diagonal stabilizer.
  ...
  \item \ixml{shift\_s}.  This is the initial coefficient used to scale the overlap-based stabilizer.
                            More stable but slower optimization is expected with a large value.
                            The adaptive method will automatically adjust this value after each linear method iteration.
  \item \ixml{target\_shift\_i}.  If set greater than zero, the adaptive method will choose the update whose shift\_i value is closest to
  ...
  \item \ixml{cost\_increase\_tol}.  Tolerance for cost function increases when selecting the best shift.
...
Recommendations:
\begin{itemize}
  \item Default \ixml{shift\_i}, \ixml{shift\_s} should be fine. 
