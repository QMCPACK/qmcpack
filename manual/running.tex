...
\item[\texttt{-{}-gpu}]{ Enables use of the GPU. To use this option QMCPACK must have
  been compiled with the \texttt{-DQMC\_CUDA=1} flag. For more details,
  see sec. \ref{sec:gpurunning}.}
