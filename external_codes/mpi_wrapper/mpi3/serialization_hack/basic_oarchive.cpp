...
//fatal error: definition of implicit copy constructor for 'aobject' is deprecated because it has a user-declared copy assignment operator [-Wdeprecated-copy]
