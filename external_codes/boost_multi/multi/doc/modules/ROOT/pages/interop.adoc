...
Although it is not ideal, arrays can be printed and formatted by looping over elements and dimension, as shown in other examples (using standard streams).
...
# We can retrieve information from an individual element, or from a row
