...
auto copy_n(
	...
	boost::multi::elements_iterator_t<::thrust::cuda::pointer<Q2>, L2> d_first
)-> boost::multi::elements_iterator_t<::thrust::cuda::pointer<Q2>, L2> {
...
template<class Q1, class L1, class Size, class Q2, class L2>
auto copy_n(
	boost::multi::elements_iterator_t<::thrust::cuda::pointer<Q1>, L1>   first, Size count,
...
template<class Q1, class L1, class Q2, class L2>
auto copy(
	boost::multi::elements_iterator_t<::thrust::cuda::pointer<Q1>, L1>   first,
	boost::multi::elements_iterator_t<::thrust::cuda::pointer<Q1>, L1>   last ,
	boost::multi::elements_iterator_t<                        Q2*, L2> d_first
)-> boost::multi::elements_iterator_t<                        Q2*, L2> {
	return boost::multi::copy_n(first, last - first, d_first);
}
