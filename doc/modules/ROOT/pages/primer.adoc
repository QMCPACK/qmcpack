...
Arrays can be viewed simultaneously as a nested array or as _flat_ sequence of elements.
...
In this way, the functions can be also applied to subblocks of larger matrices.
