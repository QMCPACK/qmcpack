...
time cmake -DQMC_COMPLEX=1 -DQMC_MIXED_PRECISION=0 -DBUILD_AFQMC=1 -DENABLE_SOA=0 -DCMAKE_C_COMPILER="mpicc" -DCMAKE_CXX_COMPILER="mpicxx" -DCMAKE_CXX_FLAGS="-mno-bmi2 -mno-avx2" -DCMAKE_C_FLAGS="-mno-bmi2 -mno-avx2" -DENABLE_CUDA=1 /tmp/${BUILD_TAG}-src 2>&1 | tee cmake.out
...
time cmake -DQMC_COMPLEX=1 -DQMC_MIXED_PRECISION=1 -DBUILD_AFQMC=1 -DCMAKE_C_COMPILER="mpicc" -DCMAKE_CXX_COMPILER="mpicxx" -DCMAKE_CXX_FLAGS="-mno-bmi2 -mno-avx2" -DCMAKE_C_FLAGS="-mno-bmi2 -mno-avx2" -DENABLE_CUDA=1 /tmp/${BUILD_TAG}-src 2>&1 | tee cmake.out
