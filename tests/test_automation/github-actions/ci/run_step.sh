...
case "$1" in 
  ...
  configure)
    ...
    then
      ...
      export LIBXML2_INCLUDE_DIR=/opt/view/include
      export LIBXML2_LIBRARY=/opt/view/lib
      ...
      echo "LIBXML2_INCLUDE_DIR=/opt/view/include" >> $GITHUB_ENV
      echo "LIBXML2_LIBRARY=/opt/view/lib" >> $GITHUB_ENV
    fi
