...
QMC_IMMUTABLE_FLAGS="-DBUILD_AFQMC=1 -DCMAKE_CXX_FLAGS=--gcc-toolchain=${GCC_TOOLCHAIN_PATH};--stdlib=stdlibc++ -DCMAKE_EXE_LINKER_FLAGS=-L${GCC_TOOLCHAIN_PATH}/lib;-Wl,-rpath,${GCC_TOOLCHAIN_PATH}/lib"
