...
if(QMC_NO_SLOW_CUSTOM_TESTING_COMMANDS)
  ...
  function(
    ...
    # TODO: fix this (maybe set during build?)
    set(RMG_DIR "/home/keving/programs/rmgdft/build2")
    message(VERBOSE "Adding test ${FULL_NAME}")
    copy_directory("${SRC_DIR}" "${MY_WORKDIR}")
    message("workdir: ${MY_WORKDIR}")
    add_rmg_test(${FULL_NAME}-scf ${NPROCS} ${NTHREADS} ${RMG_DIR}/rmg-cpu ${MY_WORKDIR} input)
