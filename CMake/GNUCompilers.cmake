...
if(ENABLE_GCOV)
  ...
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} --coverage -fkeep-inline-functions -fkeep-static-functions")
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} --coverage -fkeep-inline-functions -fkeep-static-functions")
  set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} --coverage -fkeep-inline-functions -fkeep-static-functions")
endif(ENABLE_GCOV)
