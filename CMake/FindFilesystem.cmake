...
set(_CXX_FILESYSTEM_HAVE_HEADER "" CACHE INTERNAL "")
...
if(find_final)
    ...
    if(_CXX_FILESYSTEM_HAVE_HEADER)
        ...
        # experimental one.
        message("Found <filesystem> header")
        set(find_experimental FALSE)
    endif()
else()
...
if(find_experimental)
  message("searching for experimental/filesystem")
  check_include_file_cxx(experimental/filesystem WHATEVER)
  message("_CXX_... ${_CXX_FILESYSTEM_HAVE_EXPERIMENTAL_HEADER} ${WHATEVER}")
  if(WHATEVER)
    set(_CXX_FILESYSTEM_HAVE_EXPERIMENTAL_HEADER 1)
  endif()
else()
...
message("have C++ filesystem header: ${CXX_FILESYSTEM_HAVE_FS}")
...
if(CXX_FILESYSTEM_HAVE_FS)
    ...
    message("Can build without filesystem lib flag: ${CXX_FILESYSTEM_NO_LINK_NEEDED}")
    
    if(NOT CXX_FILESYSTEM_NO_LINK_NEEDED)
        set(prev_libraries ${CMAKE_REQUIRED_LIBRARIES})
        # Add the libstdc++ flag
        set(CMAKE_REQUIRED_LIBRARIES ${prev_libraries} -lstdc++fs)
        message("Trying libstdc++fs")
...
if(Filesystem_FIND_REQUIRED AND NOT Filesystem_FOUND)
    message(FATAL_ERROR "Cannot find std::filesystem")
endif()
