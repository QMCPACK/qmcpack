    ...
    IF ( USE_MPI )
        ...
        ELSEIF ( USE_MPI )
            ...
            SET_TESTS_PROPERTIES( ${TESTNAME} PROPERTIES FAIL_REGULAR_EXPRESSION "${TEST_FAIL_REGULAR_EXPRESSION}"
                PROCESSORS ${TOT_PROCS} PROCESSOR_AFFINITY ${QMC_CTEST_PROC_AFFINITY} WORKING_DIRECTORY ${WORKDIR}
                ENVIRONMENT "OMP_NUM_THREADS=${THREADS};OMP_PLACES=cores;OMP_PROC_BIND=spread" )
