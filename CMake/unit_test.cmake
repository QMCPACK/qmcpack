...
FUNCTION( ADD_NO_MPI_UNIT_TEST TESTNAME THREADS TEST_BINARY )
    message_verbose("Adding test ${TESTNAME}")
        add_test(NAME ${TESTNAME} COMMAND ${MPIEXEC_EXECUTABLE} ${MPIEXEC_NUMPROC_FLAG} 1 ${MPIEXEC_NO_MPI_PREFLAGS} ${TEST_BINARY} ${ARGN})
        set( TEST_ADDED TRUE )
    if (TEST_ADDED)
        set_tests_properties( ${TESTNAME} PROPERTIES
                              PROCESSORS ${THREADS}
