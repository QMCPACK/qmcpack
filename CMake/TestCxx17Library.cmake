...
if (NOT CXX17_LIBRARY_OKAY)
  ...
  if (CMAKE_CXX_COMPILER_ID MATCHES "GNU") 
    message("Compiler detected is g++.\n  Use version 7.0 or newer for a C++17 standard library")
  elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    message("Compiler detected is clang++.\n  If not using libcxx, ensure a g++ version greater than 7.0 is on the path")
  elseif(CMAKE_CXX_COMPILER_ID MATCHES "Intel")
    message("Compiler detected is icpc.\n  Ensure a gcc version greater than 7.0 is on the path.  Or use the -cxxlib switch to point to a newer gcc install.")
  endif()
