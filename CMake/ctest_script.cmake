...
#Always explicitly enable/disable MPI in testing
IF ( DEFINED QMC_MPI )
  SET( CTEST_OPTIONS "${CTEST_OPTIONS};-DQMC_MPI='${QMC_MPI}'" )
ELSE()
  SET( CTEST_OPTIONS "${CTEST_OPTIONS};-DQMC_MPI=0" )
ENDIF()

#Always explicity enable/disable mixed precision
IF ( QMC_MIXED_PRECISION )
  SET( CTEST_OPTIONS "${CTEST_OPTIONS};-DQMC_MIXED_PRECISION='${QMC_MIXED_PRECISION}'" )
ELSE()
  SET( CTEST_OPTIONS "${CTEST_OPTIONS};-DQMC_MIXED_PRECISION=0" )
ENDIF()

#Always explicitly enable/disable SoA in testing
IF ( ENABLE_SOA )
  SET( CTEST_OPTIONS "${CTEST_OPTIONS};-DENABLE_SOA='${ENABLE_SOA}'" )
ELSE()
  SET( CTEST_OPTIONS "${CTEST_OPTIONS};-DENABLE_SOA=0" )
ENDIF()
