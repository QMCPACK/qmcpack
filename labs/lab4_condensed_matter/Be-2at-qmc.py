...
# job details
dft_job = Job(cores=16,minutes=10,app=pwscf,queue="R.qmc")
p2q_job = Job(cores=1,minutes=10,app=pw2qmcpack,queue="R.qmc")
qmc_job = Job(nodes=32,minutes=10,threads=16,app=qmcpack,queue="R.qmc")
...
for kgrid in kgrids:
    ...
    qmc = generate_qmcpack(
        ...
        job          = Job(nodes=ntwists,hours=2,threads=16,app=qmcpack,queue="R.qmc"),
        input_type   = 'basic',
        system       = bcc_Be,
        bconds       = 'ppp',
        pseudos      = qmc_pps,
