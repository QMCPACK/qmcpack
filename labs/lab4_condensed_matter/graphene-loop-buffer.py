...
# job details
dft_job = Job(nodes=1,minutes=20,app=pwscf,queue="R.qmc")
p2q_job = Job(cores=1,minutes=20,app=pw2qmcpack,queue="R.qmc")
qmc_job = Job(nodes=32,minutes=20,threads=16,app=qmcpack,queue="R.qmc")
