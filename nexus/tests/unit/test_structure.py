...
def test_rotate():
    ...
    assert(value_eq(s1.pos[-1],np.array([-s0.pos[-1][1],s0.pos[-1][0],s0.pos[-1][2]])))
    assert(value_eq(s1.axes[-1],np.array([-s0.axes[-1][1],s0.axes[-1][0],s0.axes[-1][2]])))
    assert(value_eq(s1.kaxes[-1],np.array([-s0.kaxes[-1][1],s0.kaxes[-1][0],s0.kaxes[-1][2]])))
