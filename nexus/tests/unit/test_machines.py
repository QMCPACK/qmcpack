...
def test_job_run_command():
    ...
    job_run_ref = obj({
        ...
        ('kagayaki'       , 'n1'            ) : 'mpirun -machinefile $PBS_NODEFILE -np 128 -x OMP_NUM_THREAD test.x',
        ('kagayaki'       , 'n1_p1'         ) : 'mpirun -machinefile $PBS_NODEFILE -np 1 -x OMP_NUM_THREAD test.x',
        ('kagayaki'       , 'n2'            ) : 'mpirun -machinefile $PBS_NODEFILE -np 256 -x OMP_NUM_THREAD test.x',
        ('kagayaki'       , 'n2_t2'         ) : 'mpirun -machinefile $PBS_NODEFILE -np 128 -x OMP_NUM_THREAD test.x',
        ('kagayaki'       , 'n2_t2_e'       ) : 'mpirun -machinefile $PBS_NODEFILE -np 128 -x OMP_NUM_THREAD test.x',
        ('kagayaki'       , 'n2_t2_p2'      ) : 'mpirun -machinefile $PBS_NODEFILE -np 4 -x OMP_NUM_THREAD test.x',
        })
...
export OMP_NUM_THREADS=1
export ENV_VAR=1
mpirun -machinefile $PBS_NODEFILE -np 256 -x OMP_NUM_THREAD test.x''',
        )
