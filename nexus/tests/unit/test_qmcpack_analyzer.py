...
'''
    ...
    opt_ref = obj(
        all_complete    = True,
        any_complete    = True,
        energy          = array([-10.4492255,-10.45426389,-10.45991696,
                                 -10.45830307,-10.46298481,-10.46086055],
                                dtype=float),
        energy_error    = array([0.00475437,0.00320561,0.00271802,
                                 0.00298106,0.00561322,0.00375811],
                                dtype=float),
        energy_weight   = None,
        failed          = False,
        optimal_file    = 'opt.s004.opt.xml',
        optimal_series  = 4,
        optimize        = (0.9, 0.1),
        series          = array([0,1,2,3,4,5],dtype=int),
        unstable        = False,
        variance        = array([0.60256216,0.40278743,0.39865602,
                                 0.38110459,0.38927957,0.39354343],
                                dtype=float),
        variance_error  = array([0.01476264,0.01716415,0.00934316,
                                 0.00529809,0.01204068,0.00913372],
                                dtype=float),
