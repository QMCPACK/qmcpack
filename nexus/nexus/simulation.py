...
class Simulation(NexusCore):
    ...
    def __init__(
        ...
        *,
        ...
        self.skip_submit    = skip_submit if skip_submit is not None else nexus_core.skip_submit
        ...
        nc_locdir = nexus_core.local_directory
        nc_remdir = nexus_core.remote_directory
        nc_rundir = nexus_core.runs
        nc_resdir = nexus_core.results
