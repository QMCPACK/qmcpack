%\documentclass[letterpaper,amsmath,amssymb,nofootinbib,12pt]{revtex4}
...
\usepackage[pdftex, pdfstartview = {FitH}]{hyperref} %in some tutorials it says that this command must be placed in the last line of the preamble
