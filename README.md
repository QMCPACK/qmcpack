...
For `D > 1`, these are not true language-references but types that emulate them (with reference semantics).
...
Usually, the most useful functions work on the _concept_ of an array rather than on a concrete type.
