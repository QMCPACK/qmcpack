...
+------------------------------------------------------+--------+---------------+------+----------+
| gcc-real-gpu-cuda-mixed                              | sulfur | deterministic | 2    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| gcc-complex-gpu-cuda-mixed                           | sulfur | deterministic | 2    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| gcc-real-gpu-cuda-full                               | sulfur | deterministic | 2    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| gcc-complex-gpu-cuda-full                            | sulfur | deterministic | 2    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| gcc-real-gpu-enable-cuda-afqmc-mixed                 | sulfur | deterministic | 6    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| gcc-complex-gpu-enable-cuda-afqmc-mixed              | sulfur | deterministic | 6    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| gcc-real-gpu-enable-cuda-afqmc-full                  | sulfur | deterministic | 6    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| gcc-complex-gpu-enable-cuda-afqmc-full               | sulfur | deterministic | 6    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| clang14_dev-real-gpu-enable-cuda-afqmc-offload-mixed | sulfur | deterministic | 6    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
| clang14_dev-real-gpu-enable-cuda-afqmc-offload-full  | sulfur | deterministic | 6    | manual   |
+------------------------------------------------------+--------+---------------+------+----------+
