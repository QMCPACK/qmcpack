...
support correct application of C++ 17 flags for the Intel compiler. Most
...
::
  ...
  module load gcc   # Make C++ 17 standard library available to the Intel compiler
...
IBM XL compiler does not support C++17, so we currently use the
gnu compiler.
...
::
  ...
  module load gcc/8.3.0 # Make C++ 17 standard library available to the Intel compiler
  cd $SCRATCH
