...
~~~~~~~~~~~~~~
  ...
  +--------------------------------+--------------+-------------------------+-------------+-----------------------------------------------+
  | ``debug_mode``                 | text         | see additional info     | dep.        | Turn on/off additonal recompute and checks    |
  +--------------------------------+--------------+-------------------------+-------------+-----------------------------------------------+
...
- ``debug_mode`` valid values are 'no', 'all', 'checkGL_after_moves'. If the build type is `debug`, the default value is 'all'. Otherwise, the default value is 'no'.
...
- ``debug_mode`` valid values are 'no', 'all', 'checkGL_after_load', 'checkGL_after_moves', 'checkGL_after_tmove'. If the build type is `debug`, the default value is 'all'. Otherwise, the default value is 'no'.
