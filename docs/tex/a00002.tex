...
Einspline is distributed within Q\+M\+C\+P\+A\+C\+K and does not need to be separately installed. The official U\+R\+L for the standalone einspline library is {\tt http\+://einspline.\+sourceforge.\+net/}\section{External libraries}\label{a00002_extlib_sec}
...
Despite working on a 2013 Mac Pro, this recipe fails on some other Macs. This indicates that there are minor additional subtleties still to be worked out. However, this recipe should be a very good starting point.
\end{DoxyNote}
(Tested on a 2013 Mac Pro in July 2014).
