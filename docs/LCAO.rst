...
The current implementation is not highly optimized for efficiency but can handle real and complex trial wavefunctions generated by PySCF :footcite:`Sun2018`, but other codes such as
...
via optimized C and C++ libraries :footcite:`Sun2018`. Such a
