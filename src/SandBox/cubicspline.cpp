...
struct TestFunc1 {
  ...
  inline double f(double x) { return std::sin(k0*x); }
  inline double df(double x) { return k0*std::cos(k0*x); }
  inline double d2f(double x) { return minusksq*std::sin(k0*x); }
};
