...
vec wt = {0.08333333582,0.08333333582,0.08333333582,0.08333333582,0.08333333582,0.08333333582,0.08333333582,0.08333333582,0.08333333582,0.08333333582,0.08333333582,0.08333333582};
...
dcomp spinor(const vec& sph, double s)
{
...
dcomp lMatrixElement(int l, int m1, int m2, int d)
{
    ...
    switch(d)
    {
        case 0:
            ...
            val = 0.5*(pref1*kroneckerDelta(m1,m2+1) +
                              pref2*kroneckerDelta(m1,m2-1));
...
dcomp calcAngInt(const vec& sph1,
                 double s1,
                 double s2)
{
...
#pragma omp parallel for reduction(+:sint)
    ...
    std::cout << npts << " " << std::setprecision(10) << std::real(sint) << " " << std::imag(sint) << " time: " << t2-t1 << std::endl;
}
