...
/*
StressPBCAA::Return_t
StressPBCAA::registerData(ParticleSet& P, BufferType& buffer)
{
  if(is_active)
  {
    P.SK->DoUpdate=true;
...
StressPBCAA::Return_t
StressPBCAA::updateBuffer(ParticleSet& P, BufferType& buffer)
{
  if(is_active)
  {
    Value=evaluateForPbyP(P);
...
void StressPBCAA::copyFromBuffer(ParticleSet& P, BufferType& buffer)
{
  if(is_active)
  {
...
void StressPBCAA::copyToBuffer(ParticleSet& P, BufferType& buffer)
{
  if(is_active)
  {
    buffer.put(SR2.begin(),SR2.end());
...
/*StressPBCAA::Return_t
StressPBCAA::evaluateForPbyP(ParticleSet& P)
{
  if(is_active)
  {
    SR2=0.0;
...
StressPBCAA::Return_t
StressPBCAA::evaluatePbyP(ParticleSet& P, int active)
{
/*  if(is_active)
  {
...
#if defined(USE_REAL_STRUCT_FACTOR)
    APP_ABORT("StressPBCAA::evaluatePbyP");
#else
    const StructFact& PtclRhoK(*(P.SK));
 ...
 * $Id: StressPBCAA.cpp 5976 2013-09-13 18:39:44Z jtkrogel $
 ***************************************************************************/
