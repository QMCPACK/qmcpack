...
namespace qmcplusplus {
  ...
  ///destructor
  NumericalRadialPotential::~NumericalRadialPotential() { if(VofR) delete VofR;}
  ...
  bool NumericalRadialPotential::put(xmlNodePtr cur) {
    ...
    radAttrib.add(npts,"npts"); radAttrib.add(npts,"size"); 
    radAttrib.add(ri,"ri"); 
    radAttrib.add(rf,"rf");
