...
inline void evaluate_gl(const T* restrict psi,
                        const TinyVector<T, D>* restrict psi_g,
                        TinyVector<T, D>* restrict g,
                        const T* restrict psi_l,
                        T* restrict l,
                        int n,
                        int m)
{
...
template<typename T, unsigned D>
inline void evaluate_gl(const T* restrict psi,
                        const TinyVector<T, D + 1>* restrict psi_gl,
                        TinyVector<T, D>* restrict g,
                        T* restrict l,
                        int n,
                        int m)
...
template<typename T>
inline void evaluate_gl(const T* restrict psi,
                        const TinyVector<T, 4>* restrict psi_gl,
                        TinyVector<T, 3>* restrict g,
                        T* restrict l,
                        int n,
                        int m)
{
...
inline void trace(const Matrix<T>& psiinv,
                  const Matrix<TinyVector<T, D>>& psi_g,
                  TinyVector<T, D>* restrict g,
                  const Matrix<T>& psi_l,
                  T* restrict l)
{
