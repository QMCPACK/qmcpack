...
try:
  ...
  import sys
  sys.exit("Error: lxml python module is needed for the generation of the XML file by PyscfToQmcpack_Spline.py. Please install it using your favorite package manager")

try:
  import pandas as pd
except:
  import sys
  sys.exit("Error: Panda python module is needed for the save_eigensystem and eigensystem functions by PyscfToQmcpack_Spline.py. Please install it using your package manager")
