...
#define BZ_DEFINE_UNARY_FUNC(name, fun)                                                                 \
  ...
  {                                                                                                     \
    typedef T_numtype1 T_numtype;                                                                       \
                                                                                                        \
    static inline T_numtype apply(T_numtype1 a) { return fun(a); }                                      \
                                                                                                        \
    template<typename T1>                                                                               \
    static inline void prettyPrint(BZ_STD_SCOPE(string) & str, prettyPrintFormat& format, const T1& t1) \
    {                                                                                                   \
      str += #fun;                                                                                      \
      str += "(";                                                                                       \
...
#define BZ_DEFINE_BINARY_FUNC(name, fun)                                                                              \
  ...
  {                                                                                                                   \
    typedef BZ_PROMOTE(T_numtype1, T_numtype2) T_numtype;                                                             \
                                                                                                                      \
    static inline T_numtype apply(T_numtype1 a, T_numtype2 b) { return fun(a, b); }                                   \
                                                                                                                      \
    template<typename T1, typename T2>                                                                                \
    static inline void prettyPrint(BZ_STD_SCOPE(string) & str, prettyPrintFormat& format, const T1& t1, const T2& t2) \
    {                                                                                                                 \
      str += #fun;                                                                                                    \
      str += "(";                                                                                                     \
      t1.prettyPrint(str, format);                                                                                    \
...
#define BZ_DEFINE_TERNARY_FUNC(name, fun)                                                            \
  ...
  struct name                                                                                        \
  {                                                                                                  \
    typedef BZ_PROMOTE(P_numtype1, BZ_PROMOTE(P_numtype2, P_numtype3)) T_numtype;                    \
                                                                                                     \
    static inline T_numtype apply(P_numtype1 x, P_numtype2 y, P_numtype3 z) { return fun(x, y, z); } \
                                                                                                     \
...
struct Fn_abs<float>
{
  ...
  static inline T_numtype apply(T_numtype1 a) { return BZ_MATHFN_SCOPE(fabs)(a); }
...
struct Fn_abs<complex<T>>
{
  ...
  static inline T_numtype apply(T_numtype1 a) { return BZ_CMATHFN_SCOPE(abs)(a); }
...
struct Cast
{
  ...
  static inline T_numtype apply(T_numtype1 a) { return T_numtype(a); }
