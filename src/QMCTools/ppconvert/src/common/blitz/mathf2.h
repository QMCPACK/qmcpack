...
public:
  ...
  static inline T_numtype apply(T_numtype1 x) { return _bz_exp<T_numtype1>::apply(x); }
...
public:
  ...
  static inline T_numtype apply(T_numtype1 x) { return _bz_sqrt<T_numtype1>::apply(x); }
...
public:
  ...
  static inline T_numtype apply(T_numtype1 x) { return BZ_NO_PROPAGATE(x) * BZ_NO_PROPAGATE(x); }
...
public:
  ...
  static inline T_numtype apply(T_numtype1 x) { return BZ_NO_PROPAGATE(x) * BZ_NO_PROPAGATE(x) * BZ_NO_PROPAGATE(x); }
...
public:
  ...
  {
    T_numtype t1 = BZ_NO_PROPAGATE(x) * BZ_NO_PROPAGATE(x);
    return BZ_NO_PROPAGATE(t1) * BZ_NO_PROPAGATE(t1) * BZ_NO_PROPAGATE(t1);
  }
...
public:
  ...
  static inline T_numtype apply(T_numtype1 x)
  {
    T_numtype t1 = BZ_NO_PROPAGATE(x) * BZ_NO_PROPAGATE(x) * BZ_NO_PROPAGATE(x);
    return BZ_NO_PROPAGATE(t1) * BZ_NO_PROPAGATE(t1);
  }
...
public:
  ...
  {
    T_numtype t1 = BZ_NO_PROPAGATE(x) * BZ_NO_PROPAGATE(x) * BZ_NO_PROPAGATE(x);
    return BZ_NO_PROPAGATE(t1) * BZ_NO_PROPAGATE(t1) * BZ_NO_PROPAGATE(x);
  }
