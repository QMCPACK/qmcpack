...
struct _bz_doArrayIndexMapping
{
  ...
  static T_numtype map(const Array<T_numtype, N_rank>&,
                       const TinyVector<int, N_destRank>&,
                       int,
                       int,
                       int,
                       int,
...
struct _bz_doArrayIndexMapping<1>
{
  ...
  static T_numtype map(const Array<T_numtype, 1>& array,
                       const TinyVector<int, N_destRank>& index,
                       int i0,
                       int,
                       int,
                       int,
...
struct _bz_doArrayIndexMapping<6>
{
  ...
  static T_numtype map(const Array<T_numtype, 6>& array,
                       ...
                       int)
  {
    return array(index[i0], index[i1], index[i2], index[i3], index[i4], index[i5]);
  }
};
...
struct _bz_doArrayIndexMapping<7>
{
  ...
  static T_numtype map(const Array<T_numtype, 7>& array,
                       ...
                       int)
  {
    return array(index[i0], index[i1], index[i2], index[i3], index[i4], index[i5], index[i6]);
  }
};
...
struct _bz_doArrayIndexMapping<8>
{
  ...
  static T_numtype map(const Array<T_numtype, 8>& array,
                       ...
                       int)
  {
    return array(index[i0], index[i1], index[i2], index[i3], index[i4], index[i5], index[i6], index[i7]);
  }
};
...
struct _bz_doArrayIndexMapping<9>
{
  ...
  static T_numtype map(const Array<T_numtype, 9>& array,
                       ...
                       int)
  {
    return array(index[i0], index[i1], index[i2], index[i3], index[i4], index[i5], index[i6], index[i7], index[i8]);
  }
};
...
public:
  ...
  /*
     ...
     * 1.  
     */
  static const int maxRank1 = (N_map0 > N_map1) ? N_map0 : N_map1, maxRank2 = (N_map2 > maxRank1) ? N_map2 : maxRank1,
  ...
  static const int numArrayOperands = 1, numIndexPlaceholders = 1, rank = maxRank10 + 1;

  ArrayIndexMapping(const Array<T_numtype, N_rank>& array) : array_(array) {}

  ArrayIndexMapping(const ArrayIndexMapping<T_numtype,
                                            N_rank,
                                            N_map0,
                                            N_map1,
                                            N_map2,
  ...
  {
    return _bz_doArrayIndexMapping<N_rank>::map(array_, i, N_map0, N_map1, N_map2, N_map3, N_map4, N_map5, N_map6,
