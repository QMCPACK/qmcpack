...
#define BZ_END_STENCIL_WITH_SHAPE(MINS, MAXS)                                                                    \
  ...
  template<int N>                                                                                                \
  void getExtent(BZ_BLITZ_SCOPE(TinyVector) < int, N > &minb, BZ_BLITZ_SCOPE(TinyVector) < int, N > &maxb) const \
  {                                                                                                              \
    minb = MINS;                                                                                                 \
    maxb = MAXS;                                                                                                 \
  }                                                                                                              \
...
#define BZ_DECLARE_STENCIL3(name, A, B, C)                                          \
  ...
  {                                                                                 \
    template<typename T1,                                                           \
             ...
             typename T10,                                                          \
             typename T11>                                                          \
    static inline void apply(T1& A, T2& B, T3& C, T4, T5, T6, T7, T8, T9, T10, T11) \
    {
#define BZ_DECLARE_STENCIL4(name, A, B, C, D)                                          \
  ...
  {                                                                                    \
    template<typename T1,                                                              \
             ...
             typename T10,                                                             \
             typename T11>                                                             \
    static inline void apply(T1& A, T2& B, T3& C, T4& D, T5, T6, T7, T8, T9, T10, T11) \
    {
#define BZ_DECLARE_STENCIL5(name, A, B, C, D, E)                                          \
  ...
  {                                                                                       \
    template<typename T1,                                                                 \
             ...
             typename T10,                                                                \
             typename T11>                                                                \
    static inline void apply(T1& A, T2& B, T3& C, T4& D, T5& E, T6, T7, T8, T9, T10, T11) \
    {
#define BZ_DECLARE_STENCIL6(name, A, B, C, D, E, F)                                          \
  ...
  {                                                                                          \
    template<typename T1,                                                                    \
             ...
             typename T10,                                                                   \
             typename T11>                                                                   \
    static inline void apply(T1& A, T2& B, T3& C, T4& D, T5& E, T6& F, T7, T8, T9, T10, T11) \
    {
#define BZ_DECLARE_STENCIL7(name, A, B, C, D, E, F, G)                                          \
  ...
  {                                                                                             \
    template<typename T1,                                                                       \
             ...
             typename T10,                                                                      \
             typename T11>                                                                      \
    static inline void apply(T1& A, T2& B, T3& C, T4& D, T5& E, T6& F, T7& G, T8, T9, T10, T11) \
    {
#define BZ_DECLARE_STENCIL8(name, A, B, C, D, E, F, G, H)                                          \
  ...
  {                                                                                                \
    template<typename T1,                                                                          \
             ...
             typename T10,                                                                         \
             typename T11>                                                                         \
    static inline void apply(T1& A, T2& B, T3& C, T4& D, T5& E, T6& F, T7& G, T8& H, T9, T10, T11) \
    {
#define BZ_DECLARE_STENCIL9(name, A, B, C, D, E, F, G, H, I)                                          \
  ...
  {                                                                                                   \
    template<typename T1,                                                                             \
             ...
             typename T10,                                                                            \
             typename T11>                                                                            \
    static inline void apply(T1& A, T2& B, T3& C, T4& D, T5& E, T6& F, T7& G, T8& H, T9& I, T10, T11) \
    {
#define BZ_DECLARE_STENCIL10(name, A, B, C, D, E, F, G, H, I, J)                                         \
  ...
  {                                                                                                      \
    template<typename T1,                                                                                \
             ...
             typename T10,                                                                               \
             typename T11>                                                                               \
    static inline void apply(T1& A, T2& B, T3& C, T4& D, T5& E, T6& F, T7& G, T8& H, T9& I, T10& J, T11) \
    {
#define BZ_DECLARE_STENCIL11(name, A, B, C, D, E, F, G, H, I, J, K)                                         \
  ...
  {                                                                                                         \
    template<typename T1,                                                                                   \
             ...
             typename T10,                                                                                  \
             typename T11>                                                                                  \
    static inline void apply(T1& A, T2& B, T3& C, T4& D, T5& E, T6& F, T7& G, T8& H, T9& I, T10& J, T11& K) \
    {
BZ_NAMESPACE(blitz)
...
public:
  ...
  _bz_typename multicomponent_traits<T>::T_element operator[](int i) const { return value_[i]; }
...
public:
  ...
  dummy<_bz_typename multicomponent_traits<T_numtype>::T_element> operator[](int)
  {
    return dummy<_bz_typename multicomponent_traits<T_numtype>::T_element>(1);
  }
  ...
  int min(int i) const { return min_[i]; }

  int max(int i) const { return max_[i]; }

  const TinyVector<int, N_rank>& min() const { return min_; }

  const TinyVector<int, N_rank>& max() const { return max_; }
  ...
  operator T_numtype() { return T_numtype(1); }

  T_numtype operator*() { return T_numtype(1); }
