...
struct Zip2
{
  ...
  static inline T_numtype apply(T1 a, T2 b) { return T_numtype(a, b); }
...
inline _bz_ArrayExpr<_bz_ArrayExprBinaryOp<
    ...
    Zip2<T_component, _bz_typename asExpr<T1>::T_expr::T_numtype, _bz_typename asExpr<T2>::T_expr::T_numtype>>>
    zip(const T1& a, const T2& b, T_component)
{
  return _bz_ArrayExpr<_bz_ArrayExprBinaryOp<
      ...
      Zip2<T_component, _bz_typename asExpr<T1>::T_expr::T_numtype, _bz_typename asExpr<T2>::T_expr::T_numtype>>>(a, b);
}
