...
_bz_inline_et _bz_ArrayExpr<
    _bz_ArrayExprUnaryOp<_bz_typename asExpr<T1>::T_expr, Cast<_bz_typename asExpr<T1>::T_expr::T_numtype, T_cast>>>
...
inline _bz_ArrayExprBinaryOp<typename asExpr<std::complex<T1>>::T_expr,
    ...
    pow(const std::complex<T1> d1, const ETBase<T2>& d2)
{
  return _bz_ArrayExprBinaryOp<
      typename asExpr<std::complex<T1>>::T_expr, typename asExpr<T2>::T_expr,
      Fn_pow<std::complex<T1>, typename asExpr<T2>::T_expr::T_numtype>>(asExpr<std::complex<T1>>::getExpr(d1),
