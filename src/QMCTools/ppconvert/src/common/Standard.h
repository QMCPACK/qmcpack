...
//PKDBGinline double min(double x, double y) { return (x <= y) ? x : y; }

//PKDBGinline int min(int x, int y) { return (x <= y) ? x : y; }

//PKDBGinline double max(double x, double y) { return (x >= y) ? x : y; }

//PKDBGinline int max(int x, int y) { return (x >= y) ? x : y; }
...
template<class T>
inline void warning(const char* m, const T& t)
{
  std::ostringstream ss;
  ss << m << " " << t;
  WriteWarning(ss);
...
template<class T, class U>
inline void warning(const char* m, const T& t, const U& u)
{
  std::ostringstream ss;
  ss << m << " " << t << " " << u;
  WriteWarning(ss);
...
template<class T, class U, class V>
inline void warning(const char* m, const T& t, const U& u, const V& v)
{
  std::ostringstream ss;
  ss << m << " " << t << " " << u << " " << v;
  WriteWarning(ss);
...
template<class T, class U, class V, class W>
inline void warning(const char* m, const T& t, const U& u, const V& v, const W& w)
{
  std::ostringstream ss;
  ss << m << " " << t << " " << u << " " << v << " " << w;
  WriteWarning(ss);
...
template<class T, class U, class V, class W, class X>
inline void warning(const char* m, const T& t, const U& u, const V& v, const W& w, const X& x)
{
  std::ostringstream ss;
  ss << m << " " << t << " " << u << " " << v << " " << w << " " << x;
  WriteWarning(ss);
...
template<class T, class U, class V, class W, class X, class Y>
inline void warning(const char* m, const T& t, const U& u, const V& v, const W& w, const X& x, const Y& y)
{
  std::ostringstream ss;
  ss << m << " " << t << " " << u << " " << v << " " << w << " " << x << " " << y;
  WriteWarning(ss);
...
template<class T, class U, class V, class W, class X, class Y, class Z>
inline void warning(const char* m, const T& t, const U& u, const V& v, const W& w, const X& x, const Y& y, const Z& z)
{
  std::ostringstream ss;
  ss << m << " " << t << " " << u << " " << v << " " << w << " " << x << " " << y << " " << z;
  WriteWarning(ss);
...
inline void Limits(const int n, const int max)
{
  ...
  if ((n < 0) || (n >= max))
  {
    ...
    std::cerr << "Array error: Index out of range:  0<= " << n << " < " << max << "\n";
    Terminate();
  }
...
inline void LimitsInclusive(const int n, const int max)
{
  ...
  if ((n < 0) || (n > max))
  {
    ...
    std::cerr << "Array error: Upper limit for index out of range:  0<= " << n << " <= " << max << "\n";
    Terminate();
  }
#endif // RANGE_CHECKING
}
...
inline void EqualLimits(const int max1, const int max2)
{
  ...
  if (max1 != max2)
  {
    std::cerr << "Array copy error: array sizes not equal:" << max1 << "," << max2 << std::endl;
    Terminate();
  }
#endif // RANGE_CHECKING
}
...
inline void BiggerLimit(const int lower, const int upper)
{
  ...
  if (lower >= upper)
  {
    std::cerr << "Sub-array limits error: lower limit not lower " << lower << "," << upper << std::endl;
    Terminate();
  }
#endif // RANGE_CHECKING
}
