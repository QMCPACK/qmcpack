...
";
  ...
  REQUIRE(ions.R[0][0] == 0.1);
  REQUIRE(ions.R[0][1] == 0.2);
  REQUIRE(ions.R[0][2] == 0.3);
  ...
  REQUIRE(electrons.R[0][0] == -0.28);
  REQUIRE(electrons.R[0][1] == 0.0225);
  REQUIRE(electrons.R[0][2] == -2.709);

  REQUIRE(electrons.R[1][0] == -1.08389);
  REQUIRE(electrons.R[1][1] == 1.9679);
  REQUIRE(electrons.R[1][2] == -0.0128914);
