...
namespace einspline {
  ...
  inline void find_coefs_1d(Ugrid grid, BCtype_s bc, float *data,  intptr_t dstride,
    float *coefs, intptr_t cstride)
  {
  ...
  class BsplineAllocator
  {
    ...
    SingleSplineType*
    allocateUBspline(Ugrid x_grid, Ugrid y_grid, Ugrid z_grid,
        BCType xBC, BCType yBC, BCType zBC, T* data=nullptr);
