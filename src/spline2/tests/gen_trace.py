...
The first part of this script verifies the expression for the trace of
the product of a symmetric matrix (H) and a general matrix (G).
...
vH = Matrix([[1.0, 2.0, 3.0], [2.0, 4.4, 1.1], [3.0, 1.1, 0.9]])
vG = Matrix([[0.1, 0.2, 0.3], [1.4, 2.3, 8.0], [0.9, 1.4, 2.3]])
