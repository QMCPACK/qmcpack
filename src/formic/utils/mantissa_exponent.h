...
public:
  ...
  {
    if (_z > other._z)
      return (*this) * (formic::unity(T()) + ((other) / (*this)).get());
...
///////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
inline formic::MantExp<T> operator*(const formic::MantExp<T>& m, const T x)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
inline formic::MantExp<T> operator*(const T x, const formic::MantExp<T>& m)
{
  return formic::MantExp<T>(m.mantissa() * x, m.exponent());
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
inline formic::MantExp<T> sqrt(const formic::MantExp<T>& m)
{
  if (m.exponent() % 2 == 0)
