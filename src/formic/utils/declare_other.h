...
extern "C" {
  ...
  std::complex<double> FC_GLOBAL(zdotu,ZDOTU)(int *n, const std::complex<double> *x, int *incx, const std::complex<double> *y, int *incy);
  std::complex<double> FC_GLOBAL(zdotc,ZDOTC)(int *n, const std::complex<double> *x, int *incx, const std::complex<double> *y, int *incy);
