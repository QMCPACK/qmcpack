...
namespace ma 
{
  ...
  inline static
  void getri_bufferSize (int n, float const* a, int lda, int& lwork)
  {
    float work;
    int status;
    lwork = -1;
  ...
  inline static
  void getri_bufferSize (int n, double const* a, int lda, int& lwork)
  {
    double work;
    int status;
    lwork = -1;
  ...
  inline static
  void getri_bufferSize (int n, std::complex<float> const* a, int lda, int& lwork)
  {
  ...
  inline static
  void getri_bufferSize (int n, std::complex<double> const* a, int lda, int& lwork)
  {
