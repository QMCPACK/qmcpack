...
{
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::dot catch all.");
...
{
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::axpy catch all.");
}
...
inline static void gemv(char Atrans, int M, int N, T alpha, ptrA A, int lda, ptrB x, int incx, T beta, ptrC y, int incy)
{
  ...
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::gemv catch all.");
}
                        ...
                        int ldc)
{
  ...
  print_stacktrace throw std::runtime_error("Error: Unimplemented qmc_cuda::gemm with mixed pointers.");
}
                        ...
                        int ldc)
{
  std::cout << " types: (geam)"
            ...
            << "  ptrB: " << typeid(B).name() << "\n"
            << "  ptrC: " << typeid(C).name() << std::endl;
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::geam catch all.");
}
                           ...
                           ptrC result)
{
  ...
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::adotpby catch all.");
}
                                   ...
                                   int inc)
{
  std::cout << " types: (strided_adotpby)"
            ...
            << "  ptrB: " << typeid(y).name() << "\n"
            << "  ptrC: " << typeid(result).name() << std::endl;
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::strided_adotpby catch all.");
}
...
inline static void axty(int n, T const alpha, ptrA const x, int incx, ptrB y, int incy)
{
  ...
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::axty catch all.");
}
                           ...
                           int ldb)
{
  ...
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::acAxpbB catch all.");
}
...
inline static void adiagApy(int n, T const alpha, ptrA const A, int lda, ptrB y, int incy)
{
  std::cout << " types: "
            ...
            << "  ptrA: " << typeid(A).name() << "\n"
            << "  ptrB: " << typeid(y).name() << std::endl;
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::adiagApy catch all.");
}
                                      ...
                                      int batchSize)
{
  std::cout << " types: (gemmStridedBatched)"
            ...
            << "  ptrB: " << typeid(B).name() << "\n"
            << "  ptrC: " << typeid(C).name() << std::endl;
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::gemmStridedBatched catch all.");
}
                               ...
                               int batchSize)
{
  std::cout << " types: (gemmBatched) "
            ...
            << "  ptrB: " << typeid(B).name() << "\n"
            << "  ptrC: " << typeid(C).name() << std::endl;
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::gemmBatched catch all.");
}
