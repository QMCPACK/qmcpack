           ...
           const int ldc)
{
  ...
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::csrmm catch all.");
}
           ...
           ptrC y)
{
  ...
  print_stacktrace throw std::runtime_error("Error: Calling qmc_cuda::csrmv catch all.");
}
