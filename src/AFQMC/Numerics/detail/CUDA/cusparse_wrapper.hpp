...
namespace cusparse {
  ...
  // Level-2
  inline cusparseStatus_t cusparse_csrmv(cusparseHandle_t handle, char Atrans, 
...

  {
    cusparseStatus_t sucess =
                cusparseDcsrmv(handle,cusparseOperation(Atrans),m,n,nnz,&alpha,
  ...
  {
    cusparseStatus_t sucess =
                cusparseScsrmv(handle,cusparseOperation(Atrans),m,n,nnz,&alpha,
                               descrA,csrValA,csrRowPtrA,csrColIndA,x,&beta,y); 
    cudaDeviceSynchronize ();
    return sucess;
  }
  ...
  {
    cusparseStatus_t sucess =
                cusparseZcsrmv(handle,cusparseOperation(Atrans),m,n,nnz,
                               reinterpret_cast<cuDoubleComplex const*>(&alpha),
                               descrA,
                               reinterpret_cast<cuDoubleComplex const*>(csrValA),
                               csrRowPtrA,csrColIndA,
                               reinterpret_cast<cuDoubleComplex const*>(x),
  ...
  {
    cusparseStatus_t sucess =
                cusparseCcsrmv(handle,cusparseOperation(Atrans),m,n,nnz,
                               reinterpret_cast<cuComplex const*>(&alpha),
                               descrA,
                               reinterpret_cast<cuComplex const*>(csrValA),
                               csrRowPtrA,csrColIndA,
                               reinterpret_cast<cuComplex const*>(x),
  ...
  inline cusparseStatus_t cusparse_csrmm(cusparseHandle_t handle, char Atrans,
  ...
  {
    cusparseStatus_t sucess =
                cusparseDcsrmm(handle,cusparseOperation(Atrans),
  ...
  {
    cusparseStatus_t sucess =
                cusparseScsrmm(handle,cusparseOperation(Atrans),
                               m,n,k,nnz,&alpha,descrA,csrValA,csrRowPtrA,csrColIndA,
                               B,ldb,&beta,C,ldc);
    cudaDeviceSynchronize ();
    return sucess;
  ...
  {
    cusparseStatus_t sucess =
                cusparseZcsrmm(handle,cusparseOperation(Atrans),
                               m,n,k,nnz,
                               reinterpret_cast<cuDoubleComplex const*>(&alpha),
                               descrA,
                               reinterpret_cast<cuDoubleComplex const*>(csrValA),
  ...
  {
    cusparseStatus_t sucess =
                cusparseCcsrmm(handle,cusparseOperation(Atrans),
                               m,n,k,nnz,
                               reinterpret_cast<cuComplex const*>(&alpha),
                               descrA,
                               reinterpret_cast<cuComplex const*>(csrValA),
  ...
  inline cusparseStatus_t cusparse_csrmm2(cusparseHandle_t handle, char Atrans,
  ...
  {
    cusparseStatus_t sucess =
                cusparseDcsrmm2(handle,cusparseOperation(Atrans),cusparseOperation(Btrans),
                               m,n,k,nnz,&alpha,descrA,csrValA,csrRowPtrA,csrColIndA,
                               B,ldb,&beta,C,ldc); 
    cudaDeviceSynchronize ();
    return sucess;
  ...
  {
    cusparseStatus_t sucess =
                cusparseScsrmm2(handle,cusparseOperation(Atrans),cusparseOperation(Btrans),
                               m,n,k,nnz,&alpha,descrA,csrValA,csrRowPtrA,csrColIndA,
                               B,ldb,&beta,C,ldc);
    cudaDeviceSynchronize ();
    return sucess;
  ...
  {
    cusparseStatus_t sucess =
                cusparseZcsrmm2(handle,cusparseOperation(Atrans),cusparseOperation(Btrans),
                               m,n,k,nnz,
                               reinterpret_cast<cuDoubleComplex const*>(&alpha),
                               descrA,
                               reinterpret_cast<cuDoubleComplex const*>(csrValA),
  ...
  {
    cusparseStatus_t sucess =
                cusparseCcsrmm2(handle,cusparseOperation(Atrans),cusparseOperation(Btrans),
                               m,n,k,nnz,
                               reinterpret_cast<cuComplex const*>(&alpha),
                               descrA,
                               reinterpret_cast<cuComplex const*>(csrValA),
  ...
  {
    cusparseStatus_t sucess =
                cusparseDgemmi(handle,m,n,k,nnz,&alpha,A,lda,cscValB,
  ...
  {
    cusparseStatus_t sucess =
                cusparseSgemmi(handle,m,n,k,nnz,&alpha,A,lda,cscValB,
                               cscColPtrB,cscRowIndB,&beta,C,ldc);
    cudaDeviceSynchronize ();
    return sucess;
  }
  ...
  {
    cusparseStatus_t sucess =
                cusparseZgemmi(handle,m,n,k,nnz,
                               reinterpret_cast<cuDoubleComplex const*>(&alpha),
                               reinterpret_cast<cuDoubleComplex const*>(A),lda,
                               reinterpret_cast<cuDoubleComplex const*>(cscValB),
  ...
  {
    cusparseStatus_t sucess =
                cusparseCgemmi(handle,m,n,k,nnz,
                               reinterpret_cast<cuComplex const*>(&alpha),
                               reinterpret_cast<cuComplex const*>(A),lda,
                               reinterpret_cast<cuComplex const*>(cscValB),
                               cscColPtrB,cscRowIndB,
                               reinterpret_cast<cuComplex const*>(&beta),
                               reinterpret_cast<cuComplex *>(C),ldc);
    cudaDeviceSynchronize ();
