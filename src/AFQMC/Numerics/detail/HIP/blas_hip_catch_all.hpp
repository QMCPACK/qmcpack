...
*/
  ...
  {
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::dot catch all."); 
  ...
  {
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::axpy catch all."); 
  }
                          ...
                          ptrC y, int incy)
  {
    ...
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::gemv catch all."); 
  }
                          ...
                          ptrC C, int ldc)
  {
    ...
    print_stacktrace
    throw std::runtime_error("Error: Unimplemented qmc_hip::gemm with mixed pointers."); 
  }
                         ...
                         ptrC C, int ldc)
  {
    std::cout<<" types: (geam)"
             ...
             <<"  ptrC: " <<typeid(C).name() <<std::endl;
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::geam catch all."); 
  }
  ...
  inline static void adotpby(int const n, T const alpha, ptrA x, int const incx, ptrB y, int const incy, Q const beta, ptrC result)
  {
    ...
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::adotpby catch all."); 
  }
  ...
  inline static void strided_adotpby(int nb, int const n, T const alpha, ptrA x, int const incx, ptrB y, int const incy, Q const beta, ptrC result, int inc)
  {
    std::cout<<" types: (strided_adotpby)"
             ...
             <<"  ptrC: " <<typeid(result).name() <<std::endl;
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::strided_adotpby catch all.");
  }
                         ...
                         ptrB y, int incy)
  {
    ...
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::axty catch all."); 
  }
                             ...
                             ptrB B, int ldb)
  {
    ...
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::acAxpbB catch all."); 
  }
                         ...
                         ptrB y, int incy)
  {
    std::cout<<" types: "
             ...
             <<"  ptrB: " <<typeid(y).name() <<std::endl;
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::adiagApy catch all."); 
  }
                          ...
                          ptrC C, int ldc, int strideC, int batchSize)
  {
    std::cout<<" types: (gemmStridedBatched)"
             ...
             <<"  ptrC: " <<typeid(C).name() <<std::endl;
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::gemmStridedBatched catch all."); 
  }
                          ...
                          ptrC * C, int ldc, int batchSize)
  {
    std::cout<<" types: (gemmBatched) "
             ...
             <<"  ptrC: " <<typeid(C).name() <<std::endl;
    print_stacktrace
    throw std::runtime_error("Error: Calling qmc_hip::gemmBatched catch all."); 
  }
