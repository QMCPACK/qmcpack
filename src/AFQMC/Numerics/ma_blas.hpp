...
int main(){
	...
	{
		boost::multi::array_ref<double, 1> V(v.data(), boost::extents[v.size()]);
		ma::scal(2., V);
		{
			std::vector<double> v2 = {2.,4.,6.};
			boost::multi::array_ref<double, 1> V2(v2.data(), boost::extents[v2.size()]);
			assert( V == V2 );
		}
	}
	...
	boost::multi::array_ref<double, 2> M(m.data(), boost::extents[3][3]);
	...
	ma::scal(2., M[2]);
	{
		...
		boost::multi::array_ref<double, 2> M2(m2.data(), boost::extents[3][3]);
		assert( M == M2 );
	}
	typedef boost::multi::array_types::index_range range_t;
	boost::multi::array_types::index_gen indices;
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> M(m.data(), boost::extents[3][4]);
		assert( M[2][0] == 14. );
		std::vector<double> x = {1.,2.,3., 4.};
		boost::multi::array_ref<double, 1> X(x.data(), boost::extents[x.size()]);
		std::vector<double> y = {4.,5.,6.};
		boost::multi::array_ref<double, 1> Y(y.data(), boost::extents[y.size()]);
		ma::gemv<'T'>(1., M, X, 0., Y); // y := M x

		std::vector<double> y2 = {183., 88.,158.};
		boost::multi::array_ref<double, 1> Y2(y2.data(), boost::extents[y2.size()]);
		assert( Y == Y2 );
	}
	{
		std::vector<double> m = {
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> M(m.data(), boost::extents[4][3]);
		assert( M[2][0] == 14. );
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> A(a.data(), boost::extents[2][4]);
		...
		boost::multi::array_ref<double, 2> B(b.data(), boost::extents[3][4]);
		assert( B.num_elements() == b.size());

		std::vector<double> c(6);
		boost::multi::array_ref<double, 2> C(c.data(), boost::extents[3][2]);
		...
		boost::multi::array_ref<double, 2> TAB(tab.data(), boost::extents[3][2]);
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> A(a.data(), boost::extents[2][3]);
		assert( A.num_elements() == a.size() );
		std::vector<double> b = {
			9.,24., 6., 8., 
			4.,10., 2., 5.,
		};
		boost::multi::array_ref<double, 2> B(b.data(), boost::extents[2][4]);
		assert( B.num_elements() == b.size());

		std::vector<double> c(12);
		boost::multi::array_ref<double, 2> C(c.data(), boost::extents[4][3]);
		assert( C.num_elements() == c.size());
		...
		boost::multi::array_ref<double, 2> TAB(tab.data(), boost::extents[4][3]);
		assert( TAB.num_elements() == tab.size());
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> A(a.data(), boost::extents[4][3]);
		assert( A.num_elements() == a.size() );
		std::vector<double> b = {
			9.,24., 6., 8., 
			4.,10., 2., 5.,
		...
		boost::multi::array_ref<double, 2> C(c.data(), boost::extents[3][3]);
		assert( C.num_elements() == c.size());
		...
		boost::multi::array_ref<double, 2> TAB(tab.data(), boost::extents[3][3]);
		assert( TAB.num_elements() == tab.size());
		assert( C == TAB );
	}
	{
		...
		boost::multi::array_ref<double, 2> A(a.data(), boost::extents[3][3]);
		assert( A.num_elements() == a.size() );
		std::vector<double> b = {
			9.,24., 4.,
			4.,10., 1.,
		...
		boost::multi::array_ref<double, 2> B(b.data(), boost::extents[3][3]);
		assert( B.num_elements() == b.size());
		std::vector<double> c(9);
		boost::multi::array_ref<double, 2> C(c.data(), boost::extents[3][3]);
		assert( C.num_elements() == c.size());
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> C(c.data(), boost::extents[4][2]);
		assert( C.num_elements() == c.size());
		...
		boost::multi::array_ref<double, 2> TAB(tab.data(), boost::extents[4][2]);
		assert( TAB.num_elements() == tab.size());
		assert( C == TAB );
	}
	{
		...
		boost::multi::array_ref<double, 2> B(b.data(), boost::extents[4][3]);
		assert( B.num_elements() == b.size());
		std::vector<double> c = {
			9.,24., 8.,
			4.,10., 9.
