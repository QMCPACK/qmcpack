...
int main(){
	...
	boost::multi::array_ref<double, 2> M(m.data(), boost::{3,3});
	...
	ma::scal(2., M[2]);
	{
		...
		boost::multi::array_ref<double, 2> M2(m2.data(), boost::{3,3});
		assert( M == M2 );
	}
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> M(m.data(), boost::{3,4});
		assert( M[2][0] == 14. );
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> M(m.data(), boost::{4,3});
		assert( M[2][0] == 14. );
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> A(a.data(), boost::{2,4});
		...
		boost::multi::array_ref<double, 2> B(b.data(), boost::{3,4});
		assert( B.num_elements() == b.size());

		std::vector<double> c(6);
		boost::multi::array_ref<double, 2> C(c.data(), boost::{3,2});
		...
		boost::multi::array_ref<double, 2> TAB(tab.data(), boost::{3,2});
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> A(a.data(), boost::{2,3});
		assert( A.num_elements() == a.size() );
		std::vector<double> b = {
			9.,24., 6., 8., 
			4.,10., 2., 5.,
		};
		boost::multi::array_ref<double, 2> B(b.data(), boost::{2,4});
		assert( B.num_elements() == b.size());

		std::vector<double> c(12);
		boost::multi::array_ref<double, 2> C(c.data(), boost::{4,3});
		assert( C.num_elements() == c.size());
		...
		boost::multi::array_ref<double, 2> TAB(tab.data(), boost::{4,3});
		assert( TAB.num_elements() == tab.size());
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> A(a.data(), boost::{4,3});
		assert( A.num_elements() == a.size() );
		std::vector<double> b = {
			9.,24., 6., 8., 
			4.,10., 2., 5.,
		...
		boost::multi::array_ref<double, 2> C(c.data(), boost::{3,3});
		assert( C.num_elements() == c.size());
		...
		boost::multi::array_ref<double, 2> TAB(tab.data(), boost::{3,3});
		assert( TAB.num_elements() == tab.size());
		assert( C == TAB );
	}
	{
		...
		boost::multi::array_ref<double, 2> A(a.data(), boost::{3,3});
		assert( A.num_elements() == a.size() );
		std::vector<double> b = {
			9.,24., 4.,
			4.,10., 1.,
		...
		boost::multi::array_ref<double, 2> B(b.data(), boost::{3,3});
		assert( B.num_elements() == b.size());
		std::vector<double> c(9);
		boost::multi::array_ref<double, 2> C(c.data(), boost::{3,3});
		assert( C.num_elements() == c.size());
	...
	}
	{
		...
		boost::multi::array_ref<double, 2> C(c.data(), boost::{4,2});
		assert( C.num_elements() == c.size());
		...
		boost::multi::array_ref<double, 2> TAB(tab.data(), boost::{4,2});
		assert( TAB.num_elements() == tab.size());
		assert( C == TAB );
	}
	{
		...
		boost::multi::array_ref<double, 2> B(b.data(), boost::{4,3});
		assert( B.num_elements() == b.size());
		std::vector<double> c = {
			9.,24., 8.,
			4.,10., 9.
