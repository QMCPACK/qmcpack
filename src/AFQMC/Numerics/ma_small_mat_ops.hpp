...
namespace ma{
  ...
  template<typename T>
  inline static
  T D2x2(T const a11, T const a12,
  ...
  template<typename T>
  inline static
  T I2x2(T const a11, T const a12,
         T const a21, T const a22, T* M)
  {
  ...
  template<typename T>
  inline static
  T D3x3(T const a11, T const a12, T const a13,
  ...
  template<typename T>
  inline static
  T I3x3(T const a11, T const a12, T const a13,
        T const a21, T const a22, T const a23,
        T const a31, T const a32, T const a33, T* M)
  {
  ...
  T I3x3(T const a11, T const a12, T const a13,
        T const a21, T const a22, T const a23,
        T const a31, T const a32, T const a33, Mat& M)
  {
    T det = (a11*(a22*a33-a32*a23)-a21*(a12*a33-a32*a13)+a31*(a12*a23-a22*a13));
  ...
  template<typename T>
  inline static
  T D4x4(T const a11, T const a12, T const a13, T const a14,
  ...
  template<typename T>
  inline static
  T D5x5(T const a11, T const a12, T const a13, T const a14, T const a15,
