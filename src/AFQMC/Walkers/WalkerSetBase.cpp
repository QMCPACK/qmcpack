...
void WalkerSetBase::parse(xmlNodePtr cur)
{
 ...
 */
void WalkerSetBase::reserve(int n)
{
  if(capacity() < n) 
 ...
 */
void WalkerSetBase::resize(int n) {
...
void WalkerSetBase::popControl(std::vector<ComplexType>& curData)
{
...
void WalkerSetBase::benchmark(std::string& blist,int maxnW,int delnW,int repeat)
{
