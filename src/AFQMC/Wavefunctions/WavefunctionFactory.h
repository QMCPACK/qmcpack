...
class WavefunctionFactory
{
  ...
  ComplexType slaterCondon0(Hamiltonian& ham, std::vector<int>& det, int NMO);
  ComplexType slaterCondon1(Hamiltonian& ham, std::vector<int>& excit, std::vector<int>& det, int NMO);
  ComplexType slaterCondon2(Hamiltonian& ham, std::vector<int>& excit, int NMO);
  void createDeterminant(int idet, boost::multi::array_ref<int,1>& occa, boost::multi::array_ref<int,1>& occb, std::vector<int>& det, int NMO);
