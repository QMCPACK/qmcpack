...
/*!
 * \brief We want to minimize the cost function with respect to a set of
  parameters.  The choice of the cost function depends on the application.  
  The local energy
  \f[
 ...
 * \brief Reset the Wavefunction \f$ \Psi({\bf R},{{\bf \alpha_i}}) \f$ 
 from the old parameter set \f$ {{\bf \alpha_i}} \f$ to the new parameter
