...
{
/// Constructor.
VMCLinearOptOMP::VMCLinearOptOMP(MCWalkerConfiguration& w,
...
VMCLinearOptOMP::RealType VMCLinearOptOMP::fillOverlapHamiltonianMatrices(Matrix<RealType>& LeftM,
                                                                          Matrix<RealType>& RightM)
{
  RealType b1, b2;
  if (GEVtype == "H2")
  {
...
bool VMCLinearOptOMP::put(xmlNodePtr q)
{
  //nothing to add
  return true;
}
