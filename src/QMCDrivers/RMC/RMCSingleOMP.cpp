...
void RMCSingleOMP::resetReptiles(std::vector<ReptileConfig_t>& reptile_samps, RealType tau)
{
  if (reptile_samps.empty())
  {
    APP_ABORT("RMCSingleOMP::resetReptiles(std::vector< ReptileConfig_t > reptile_samps):  No samples!\n");
  }
  else
  {
...
void RMCSingleOMP::resetReptiles(std::vector<ParticlePos_t>& walker_samps, int nBeads_in, RealType tau)
{
  if (walker_samps.empty())
  {
    APP_ABORT("RMCSingleOMP::resetReptiles(std::vector< ParticlePos_t > walker_samps):  No samples!\n");
  }
  else
  {
