...
/// Constructor.
DMCUpdatePbyPL2VMC::DMCUpdatePbyPL2VMC(MCWalkerConfiguration& w,
...
/// destructor
DMCUpdatePbyPL2VMC::~DMCUpdatePbyPL2VMC() {}

void DMCUpdatePbyPL2VMC::advanceWalker(Walker_t& thisWalker, bool recompute)
{
