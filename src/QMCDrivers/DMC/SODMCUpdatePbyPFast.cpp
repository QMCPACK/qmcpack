...
{
  static const std::vector<std::string> SODMCTimerNames = {"SODMCUpdatePbyP::Buffer", "SODMCUpdatePbyP::movePbyP",
                                                           "SODMCUpdatePbyP::Hamiltonian",
                                                           "SODMCUpdatePbyP::Collectables", "SODMCUpdatePbyP::Tmoves"};
