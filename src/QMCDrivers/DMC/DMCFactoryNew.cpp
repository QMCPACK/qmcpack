...
{
QMCDriverInterface* DMCFactoryNew::create(const ProjectData& project_info,
                                          MCPopulation&& pop,
                                          ...
                                          Communicate* comm)
{
  ...
  QMCDriverInterface* qmc = new DMCBatched(project_info, std::move(qmcdriver_input), std::move(dmcdriver_input),
                                           std::move(pop), psi, h, comm);
