...
{
enum LinearOptTimers
{
  LinOpt_generateSamples,
  LinOpt_initialize,
  LinOpt_eigenvalue,
  LinOpt_lineMinimization,
  LinOpt_costFunction
};

TimerNameList_t<LinearOptTimers> LinearOptTimerNames{{LinOpt_generateSamples, "QMCLinearOptimize::GenerateSamples"},
                                                     {LinOpt_initialize, "QMCLinearOptimize::Initialize"},
                                                     {LinOpt_eigenvalue, "QMCLinearOptimize::Eigenvalue"},
                                                     {LinOpt_lineMinimization, "QMCLinearOptimize::Line_Minimization"},
                                                     {LinOpt_costFunction, "QMCLinearOptimize::CostFunction"}};
      ...
      param_tol(1e-4)
{
  ...
  setup_timers(myTimers, LinearOptTimerNames, timer_level_medium);
}
...
void QMCLinearOptimize::start()
{
  ...
  //generate samples
  myTimers[LinOpt_generateSamples]->start();
  generateSamples();
  myTimers[LinOpt_generateSamples]->stop();
