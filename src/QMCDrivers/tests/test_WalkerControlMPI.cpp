...
void UnifiedDriverWalkerControlMPITest::testMultiplicity(std::vector<int>& rank_counts_expanded, std::vector<int>& rank_counts_after)
{
...
void UnifiedDriverWalkerControlMPITest::testPopulationDiff(std::vector<int>& rank_counts_before, std::vector<int>& rank_counts_after)
{
  using MCPWalker = MCPopulation::MCPWalker;
