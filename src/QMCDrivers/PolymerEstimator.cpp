...
namespace qmcplusplus {
  ...
  void PolymerEstimator::resetReportSettings(const string& aname) {
    ...
    int uno=1; int isize=sizeof(int); int dsize=sizeof(double);
    ReptileLength=Reptile.size(); EpotLength=ReptileLength*nPsi;
    EpotSize=EpotLength*dsize; ElocSize=nPsi*dsize;
