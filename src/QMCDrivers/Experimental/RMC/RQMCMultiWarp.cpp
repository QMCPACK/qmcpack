...
namespace qmcplusplus { 
  ...
  bool RQMCMultiWarp::run() { 
    ...
    for(int ipsi=0; ipsi<nPsi; ipsi++)Norm[ipsi]=0.0;
 ...
 * $Revision: 3021 $   $Date: 2008-08-18 16:49:32 -0500 (Mon, 18 Aug 2008) $
 * $Id: RQMCMultiWarp.cpp 3021 2008-08-18 21:49:32Z jnkim $ 
 ***************************************************************************/
