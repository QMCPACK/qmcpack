...
void QMCCostFunction::descent_checkConfigurations(std::vector<Return_t>& LDerivs, bool& targetExcited, double omega, DescentEngine& descentEngineObj)
{


    //Seem to need this line to get non-zero derivatives for traditional Jastrow parameters.
...
//Currently only ground state optimization is implemented and well tested
//Derivatives of excited state functional will be computed in else branch in future
if(!targetExcited)
{
