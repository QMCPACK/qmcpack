...
void buildJ2(J2Type& J2, double rcut)
{
  ...
  { //add uu/dd
    std::vector<RealType> Y = {0.4711f, 0.3478f, 0.2445f, 0.1677f, 0.1118f, 0.0733f,
                               0.0462f, 0.0273f, 0.0145f, 0.0063f, 0.0f};
  ...
  { //add ud/du
    std::vector<RealType> Y = {0.6715f, 0.4433f, 0.2901f, 0.1889f, 0.1227f, 0.0793f,
                               0.0496f, 0.0292f, 0.0152f, 0.0061f, 0.0f};
