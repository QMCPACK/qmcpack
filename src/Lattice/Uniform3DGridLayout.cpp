...
void Uniform3DGridLayout::SetLRCutoffs()
{
  ...
  for (int i = 0; i < 3; i++)
  {
    ...
    value_type beta1 =
        (dot(v2, v2) * dot(c, v1) - dot(v1, v2) * dot(c, v2)) / (dot(v1, v1) * dot(v2, v2) - dot(v1, v2) * dot(v1, v2));
    value_type beta2 =
        (dot(v1, v1) * dot(c, v2) - dot(v1, v2) * dot(c, v1)) / (dot(v1, v1) * dot(v2, v2) - dot(v1, v2) * dot(v1, v2));
