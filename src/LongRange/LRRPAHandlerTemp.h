 ...
 */
#ifndef QMCPLUSPLUS_LRRPAHANLDERTEMP_H
#define QMCPLUSPLUS_LRRPAHANLDERTEMP_H
...
class LRRPAHandlerTemp: public LRHandlerBase
{
...
public:
  ...
  //Constructor
  LRRPAHandlerTemp(ParticleSet& ref, RealType kc_in=-1.0):
