...
struct SPOSetInputInfo
{
  ...
  SPOSetInputInfo(xmlNodePtr cur) { put(cur); }

  SPOSetInputInfo() { reset(); }
  ...
  inline int min_index() { return lowest_index; }

  inline int max_index() { return highest_index; }

  inline RealType min_energy() { return lowest_energy; }
