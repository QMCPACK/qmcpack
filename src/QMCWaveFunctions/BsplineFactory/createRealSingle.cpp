...
namespace qmcplusplus
{
  ...
  BsplineReaderBase* createBsplineRealSingle(EinsplineSetBuilder* e, bool hybrid_rep)
  {
    ...
    if(hybrid_rep)
      aReader= new SplineHybridAdoptorReader<HybridRealSoA<SplineR2RAdoptor<float,OHMMS_PRECISION> > >(e);
    else
      aReader= new SplineAdoptorReader<SplineR2RAdoptor<float,OHMMS_PRECISION> >(e);
    return aReader;
  }
}
