...
DiracDeterminantCUBLAS::evalGradSource(ParticleSet& P, ParticleSet& source,
                                     int iat)
{
  if(!ionDerivs) APP_ABORT("DiracDeterminantCUBLAS::evalGradSource.  Determinant not initialized for force computations.");
...
{
  if(!ionDerivs) APP_ABORT("DiracDeterminantCUBLAS::evalGradSourcep.  Determinant not initialized for force computations.");
