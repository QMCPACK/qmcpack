...
public:
  ...
  virtual inline PsiValueType ratioGradWithSpin(ParticleSet& P, int iat, GradType& grad_iat, LogValueType& spingrad_iat) override
  {
  ...
  virtual GradType evalGradWithSpin(ParticleSet& P, int iat, LogValueType& spingrad) override { return Dets[getDetID(iat)]->evalGradWithSpin(P, iat, spingrad); }
