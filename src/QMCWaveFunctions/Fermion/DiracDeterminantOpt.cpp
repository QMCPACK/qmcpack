...
{
DiracDeterminantOpt::DiracDeterminantOpt(ParticleSet& ptcl, SPOSetPtr const& gs_spos, int first)
...
DiracDeterminant* DiracDeterminantOpt::makeCopy(SPOSetPtr spo) const
{
...
void DiracDeterminantOpt::resetParameters(const opt_variables_type& optvars)
{
...
void DiracDeterminantOpt::evaluateDerivatives(ParticleSet& P,
...
void DiracDeterminantOpt::checkInVariables(opt_variables_type& active) { Phi->checkInVariables(active); }


void DiracDeterminantOpt::checkOutVariables(const opt_variables_type& active) { Phi->checkOutVariables(active); }
