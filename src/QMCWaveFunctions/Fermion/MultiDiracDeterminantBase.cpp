...
SPOSet<Batching::SINGLE>*  MultiDiracDeterminantBase::clonePhi() const
{
 ...
 */
MultiDiracDeterminantBase::MultiDiracDeterminantBase(SPOSet<Batching::SINGLE>* const &spos, int first):
