...
namespace qmcplusplus {
  ...
  OrbitalBase* PadeOnGridConstraints::createTwoBody(ParticleSet& target) {
  ...
  OrbitalBase* PadeOnGridConstraints::createOneBody(ParticleSet& target, ParticleSet& source) {
