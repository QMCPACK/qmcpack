...
#include "OneBodyJastrowOrbitalBsplineSoA.h"
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::recompute(MCWalkerConfiguration &W,
                                        bool firstTime)
{
}
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::reserve
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::checkInVariables(opt_variables_type& active)
{
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::addFunc(int ig, FT* j, int jg)
{
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::addLog (MCWalkerConfiguration &W,
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::update (std::vector<Walker_t*> &walkers, int iat)
{
  // for (int iw=0; iw<walkers.size(); iw++)
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::calcRatio
(MCWalkerConfiguration &W, int iat,
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::addRatio
(MCWalkerConfiguration &W, int iat,
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::NLratios
...
template<class FT>
void OneBodyJastrowOrbitalBsplineSoA<FT>::calcGradient
...
template<class FT>
void OneBodyJastrowOrbitalBsplineSoA<FT>::addGradient
(MCWalkerConfiguration &W, int iat, std::vector<GradType> &grad)
{
  std::vector<Walker_t*> &walkers = W.WalkerList;
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::gradLapl (MCWalkerConfiguration &W,
                                        GradMatrix_t &grad,
                                        ValueMatrix_t &lapl)
{
  std::vector<Walker_t*> &walkers = W.WalkerList;
  ...
  for (int iw=0; iw<walkers.size(); iw++)
  {
    for (int ptcl=0; ptcl<N; ptcl++)
    {
      ...
      {
        fprintf (stderr, "NAN in OneBodyJastrowOrbitalBsplineSoA<FT> laplacian.\n");
        abort();
      }
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::resetParameters(const opt_variables_type& active)
{
...
template<class FT>
void
OneBodyJastrowOrbitalBsplineSoA<FT>::evaluateDerivatives
...
template class OneBodyJastrowOrbitalBsplineSoA<BsplineFunctor<double>>;
