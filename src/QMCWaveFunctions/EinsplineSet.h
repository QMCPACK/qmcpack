...
public:
  ...
  void evaluate(const ParticleSet& P,
                ...
                RealValueVector_t& psi,
                RealGradVector_t& dpsi,
                RealHessVector_t& grad_grad_psi);
  ...
  GPU_XRAY_TRACE void evaluate(std::vector<Walker_t*>& walkers, int iat, gpu::device_vector<CTS::RealType*>& phi);
  GPU_XRAY_TRACE void evaluate(std::vector<Walker_t*>& walkers, int iat, gpu::device_vector<CTS::ComplexType*>& phi);
  GPU_XRAY_TRACE void evaluate(std::vector<Walker_t*>& walkers,
...
public:
  ...
  GPU_XRAY_TRACE SPOSet* makeClone() const;
