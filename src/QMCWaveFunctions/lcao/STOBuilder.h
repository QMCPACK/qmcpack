...
#ifndef QMCPLUSPLUS_SOA_SLATERTYPEORBITAL_BUILDER_H
#define QMCPLUSPLUS_SOA_SLATERTYPEORBITAL_BUILDER_H
...
namespace qmcplusplus
{
  ...
  template<typename T>
    struct MultiSTO
    {
      typedef SlaterCombo<T> sto_type;
      aligned_vector<sto_type*> Rnl;
   ...
   */
  template<>
    class RadialOrbitalSetBuilder<MultiSTO<QMCTraits::RealType> >
    {
      typedef OHMMS_PRECISION RealType;
      typedef MultiSTO<RealType> RadialOrbital_t;
      typedef MultiSTO<RealType>::sto_type sto_type;
