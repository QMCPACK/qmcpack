...
private:
  ...
  template<typename Fin, typename T>
    double find_cutoff(Fin& in, T rmax);
  ...
  m_rcut(-1.0), MPIObjectBase(comm), radial_grid_size_(radial_grid_size)
    { }
 ...
 */
  ...
  template<typename COT>
  template<typename Fin, typename T>
  double RadialOrbitalSetBuilder<COT>::find_cutoff(Fin& in, T rmax)
    {
