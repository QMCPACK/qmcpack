 ...
 * @brief Corrections to electron-nucleus cusp for all-electron molecular
 * calculations.
 */

#ifndef QMCPLUSPLUS_CUSPCORRECTIONT_H
#define QMCPLUSPLUS_CUSPCORRECTIONT_H
 ...
 *
 * From "Scheme for adding electron-nuclear cusps to Gaussian orbitals"  Ma,
 * Towler, Drummond, and Needs JCP 122, 224322 (2005)
 *
 * Equations 7 and 8 in the paper define the correction.  These are the
