...
struct SoaAtomicBasisSetT
{
  ...
  */
  ...
  inline void mw_evaluateVGL(const RefVectorWithLeader<SoaAtomicBasisSetT>& atom_bs_list,
                             const LAT& lattice,
                             ...
                             const size_t NumCenters)
  {
    ...
    auto& atom_bs_leader = atom_bs_list.template getCastedLeader<SoaAtomicBasisSetT<ROT, SH, ORBT>>();
