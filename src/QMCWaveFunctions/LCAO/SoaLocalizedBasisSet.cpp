...
template<class COT, typename ORBT>
  void SoaLocalizedBasisSet<COT, ORBT>::queryOrbitalsForSType(const std::vector<bool>& corrCenter, std::vector<bool>& is_s_orbital) const
  {
    const auto& IonID(ions_.GroupID);
    int idx = 0;
    for (int c = 0; c < NumCenters; c++)
...
template<class COT, typename ORBT>
  void SoaLocalizedBasisSet<COT, ORBT>::evaluateGradSourceV(const ParticleSet& P, int iat, const ParticleSet& ions, int jion, vgl_type& vgl)
  {
...
template<class COT, typename ORBT>
  void SoaLocalizedBasisSet<COT, ORBT>::evaluateGradSourceVGL(const ParticleSet& P, int iat, const ParticleSet& ions, int jion, vghgh_type& vghgh)
  {
...
template<class COT, typename ORBT>
  void SoaLocalizedBasisSet<COT, ORBT>::add(int icenter, std::unique_ptr<COT> aos) { LOBasisSet[icenter] = std::move(aos); }

template class SoaLocalizedBasisSet<SoaAtomicBasisSet<MultiQuinticSpline1D<QMCTraits::RealType>, SoaCartesianTensor<QMCTraits::RealType>>, QMCTraits::ValueType>;
template class SoaLocalizedBasisSet<SoaAtomicBasisSet<MultiQuinticSpline1D<QMCTraits::RealType>, SoaSphericalTensor<QMCTraits::RealType>>, QMCTraits::ValueType>;
template class SoaLocalizedBasisSet<SoaAtomicBasisSet<MultiFunctorAdapter<GaussianCombo<QMCTraits::RealType>>, SoaCartesianTensor<QMCTraits::RealType>>, QMCTraits::ValueType>;
template class SoaLocalizedBasisSet<SoaAtomicBasisSet<MultiFunctorAdapter<GaussianCombo<QMCTraits::RealType>>, SoaSphericalTensor<QMCTraits::RealType>>, QMCTraits::ValueType>;
template class SoaLocalizedBasisSet<SoaAtomicBasisSet<MultiFunctorAdapter<SlaterCombo<QMCTraits::RealType>>, SoaCartesianTensor<QMCTraits::RealType>>, QMCTraits::ValueType>;
template class SoaLocalizedBasisSet<SoaAtomicBasisSet<MultiFunctorAdapter<SlaterCombo<QMCTraits::RealType>>, SoaSphericalTensor<QMCTraits::RealType>>, QMCTraits::ValueType>;
} // namespace qmcplusplus
