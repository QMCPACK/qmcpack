...
public:
  ...
  ///
  ///////////////////////////////////////////////////////////////////////////////////////////////
  FDLRWfn(TrialWaveFunction* const wfn_1,
          TrialWaveFunction* const wfn_2,
          ParticleSet& P,
          const bool opt_x       = true,
          const bool opt_d       = true,
          const bool singlet_loc = false,
          const bool triplet_loc = false);
  ...
  void extract_xpd_and_xmd_vars(const opt_variables_type& active,
  ...
  void evaluateDerivRatios(VirtualParticleSet& VP,
                           const opt_variables_type& optvars,
