...
public:
  ...
  void checkInVariablesExclusive(OptVariables& active) override { active.insertFrom(my_vars_); }
  void checkOutVariables(const OptVariables& active) override { my_vars_.getIndex(active); }
