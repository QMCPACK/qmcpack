                                  ...
                                  std::vector<FDLRWfn::RealType>& dhpsioverpsi)
{
  ...
  if (opt_x_vars)
  {
    ...
    std::copy(dhpsioverpsi_fdlr_x.begin(),
              dhpsioverpsi_fdlr_x.begin() + x_vars_driver.size(),
  ...
  if (opt_d_vars)
  {
    ...
    std::copy(dhpsioverpsi_fdlr_d.begin(),
              dhpsioverpsi_fdlr_d.begin() + d_vars_driver.size(),
