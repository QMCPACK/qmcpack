...
<wavefunction target='e'>
  <sposet_collection type="bspline" source="ion" href="pwscf.pwscf.h5" tilematrix="1 0 0 0 1 0 0 0 1" twistnum="0" gpu="yes" meshfactor="0.8" twist="0 0 0" precision="double">
