...
namespace qmcplusplus {
  ...
  public:
    ...
    */
    ...
    ///row i of matrix Y
    inline const ValueType* __restrict__ y(int i){ return &Y(i,0);}
    ///row i of vector matrix dY
    inline const TinyVector<ValueType,3>* __restrict__ dy(int i){ return &dY(i,0);}
    ///row i of matrix d2Y
    inline const ValueType* __restrict__ d2y(int i){ return &d2Y(i,0);}
  };
}
#endif
