...
public:
  ...
  static void flex_evaluateRatios(const RefVector<TrialWaveFunction>& WF_list, const RefVector<const VirtualParticleSet>& VP_list, std::vector<std::vector<ValueType>>& ratios, ComputeType ct = ComputeType::ALL);
