...
#ifndef QMCPLUSPLUS_EDENESTIMATORMANAGERINTEGRATIONTEST_H
#define QMCPLUSPLUS_EDENESTIMATORMANAGERINTEGRATIONTEST_H
...
/** This class is here to allow sharing of the code to stand up an evironment to integration test
 *  the energy density estimator and EstimatorManager
 */

class EDenEstimatorManagerIntegrationTest
{
public:
  ...
  MockGoldWalkerElements& getGoldElements();

  EstimatorManagerCrowd& getEmc();
  EstimatorManagerNew& getEmn();
  StdRandom<double>& getRng();
...
private:
  UPtr<testing::EnergyDensityTest> eden_test_;
  UPtr<EstimatorManagerNew> emn_;
  UPtr<EstimatorManagerCrowd> emc_;
  StdRandom<double> rng_;
};
