...
namespace qmcplusplus {
   ...
   */
  void 
  CSPolymerEstimator::add2Record(RecordNamedProperty<RealType>& record, BufferType& msg) {
  ...
  void 
  CSPolymerEstimator::accumulate(WalkerIterator first, WalkerIterator last)
  {
    //Directionless=2
