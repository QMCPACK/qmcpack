...
namespace qmcplusplus {
  ...
  struct AppendData
  {
    ...
    { 
      maxdims[0] = H5S_UNLIMITED; maxdims[1] = a.rows(); maxdims[2] = a.cols();
      curdims[0] = 1; curdims[1] = a.rows(); curdims[2] = a.cols();
      dims[0] = 1; dims[1] = a.rows(); dims[2] = a.cols();
      offset[0]=ip; offset[1]=0; offset[2]=0;
    }
