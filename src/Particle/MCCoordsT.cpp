...
{
template<typename T>
void MCCoordsT<T, CoordsType::POS>::getSubset(const std::size_t offset,
...
template<typename T>
MCCoordsT<T, CoordsType::POS>& MCCoordsT<T, CoordsType::POS>::operator+=(const MCCoordsT<T, CoordsType::POS>& rhs)
{
...
template<typename T>
void MCCoordsT<T, CoordsType::POS_SPIN>::getSubset(const std::size_t offset,
                                                   const std::size_t size,
...
template<typename T>
MCCoordsT<T, CoordsType::POS_SPIN>& MCCoordsT<T, CoordsType::POS_SPIN>::operator+=(
    const MCCoordsT<T, CoordsType::POS_SPIN>& rhs)
{
  ...
  std::transform(spins.begin(), spins.end(), rhs.spins.begin(), spins.begin(),
                 [](const FullPrecRealType& x, const FullPrecRealType& y) { return x + y; });
  return *this;
}
