...
void XMLParticleParser::getPtclAttrib(xmlNodePtr cur, int in_offset, int copy_size, int out_offset)
{
  ...
  else
  {
    ...
    {
      ParticleIndex* obj = ref_AttribList.getAttribute(otype, oname, obj);
