...
const real unit_values[nunits] =
    {count::mol, distance::A,  distance::B,    distance::m,    distance::nm,  distance::pm,   distance::fm, time::s,
     time::ms,   time::ns,     time::ps,       time::fs,       mass::kg,      mass::me,       mass::mp,     mass::amu,
     mass::Da,   energy::J,    energy::eV,     energy::Ry,     energy::Ha,    energy::kJ_mol, energy::K,    charge::C,
     charge::e,  pressure::Pa, pressure::bar,  pressure::Mbar, pressure::GPa, pressure::atm,  force::N,     force::pN,
     count::mol, distance::A,  distance::B,    distance::m,    distance::nm,  distance::pm,   distance::fm, time::s,
     time::ms,   time::ns,     time::ps,       time::fs,       mass::kg,      mass::me,       mass::mp,     mass::amu,
     mass::Da,   energy::J,    energy::eV,     energy::Ry,     energy::Ha,    energy::kJ_mol, energy::K,    charge::C,
     charge::e,  pressure::Pa, pressure::Mbar, pressure::GPa,  pressure::atm, force::N,       force::pN};
