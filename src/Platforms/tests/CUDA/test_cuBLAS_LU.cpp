...
TEST_CASE("cuBLAS_LU::computeLUDiag_batched", "[platform][CUDA]")
{
...
TEST_CASE("cuBLAS_LU::computeLogDet", "[platform][CUDA]")
{
  auto cuda_handles = std::make_unique<testing::CUDAHandles>();
  int n             = 4;
  int lda           = 4;
...
TEST_CASE("cuBLAS_LU::computeLogDet(batch=2)", "[platform][CUDA]")
{
  auto cuda_handles = std::make_unique<testing::CUDAHandles>();
  int n             = 4;
  int lda           = 4;
...
TEST_CASE("cuBLAS_LU::getrf_batched", "[platform][CUDA]")
{
  auto cuda_handles = std::make_unique<testing::CUDAHandles>();
  int n             = 4;
  int lda           = 4;
...
TEST_CASE("cuBLAS_LU::getri_batched", "[platform][CUDA]")
{
  auto cuda_handles = std::make_unique<testing::CUDAHandles>();
  int n             = 4;
  int lda           = 4;
